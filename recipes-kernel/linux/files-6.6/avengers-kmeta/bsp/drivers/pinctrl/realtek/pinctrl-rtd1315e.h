...
#ifndef PINCTRL_RTD1315E_H
#define PINCTRL_RTD1315E_H
...
#define DECLARE_RTD1315E_PIN(_pin, _name) static const unsigned int rtd1315e_## _name ##_pins[] = { _pin }
...
static const struct rtd_pin_desc rtd1315e_iso_muxes[] = {
	...
	[RTD1315E_ISO_TESTMODE] = {0},
};

static const struct rtd_pin_config_desc rtd1315e_iso_configs[] = {
	[RTD1315E_ISO_BOOT_SEL] = RTK_PIN_CONFIG(boot_sel, 0x24, 0, 0, 1, PCONF_UNSUPP, 2, 3, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_CLK] = RTK_PIN_CONFIG(emmc_clk, 0x24, 4, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_CMD] = RTK_PIN_CONFIG(emmc_cmd, 0x24, 17, 0, 1, PCONF_UNSUPP, 2, 13, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_0] = RTK_PIN_CONFIG(emmc_data_0, 0x28, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_1] = RTK_PIN_CONFIG(emmc_data_1, 0x28, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_2] = RTK_PIN_CONFIG(emmc_data_2, 0x2c, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_3] = RTK_PIN_CONFIG(emmc_data_3, 0x2c, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_4] = RTK_PIN_CONFIG(emmc_data_4, 0x30, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_5] = RTK_PIN_CONFIG(emmc_data_5, 0x30, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_6] = RTK_PIN_CONFIG(emmc_data_6, 0x34, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DATA_7] = RTK_PIN_CONFIG(emmc_data_7, 0x34, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_DD_SB] = RTK_PIN_CONFIG(emmc_dd_sb, 0x38, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_EMMC_RST_N] = RTK_PIN_CONFIG(emmc_rst_n, 0x38, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	...
	[RTD1315E_ISO_GPIO_32] = RTK_PIN_CONFIG(gpio_32, 0x4c, 5, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_GPIO_33] = RTK_PIN_CONFIG(gpio_33, 0x4c, 18, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	...
	[RTD1315E_ISO_GPIO_78] = RTK_PIN_CONFIG(gpio_78, 0x5c, 10, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_GPIO_79] = RTK_PIN_CONFIG(gpio_79, 0x60, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_GPIO_80] = RTK_PIN_CONFIG(gpio_80, 0x60, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_GPIO_81] = RTK_PIN_CONFIG(gpio_81, 0x64, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_HIF_CLK] = RTK_PIN_CONFIG(hif_clk, 0x64, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_HIF_DATA] = RTK_PIN_CONFIG(hif_data, 0x68, 0, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_HIF_EN] = RTK_PIN_CONFIG(hif_en, 0x68, 13, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_HIF_RDY] = RTK_PIN_CONFIG(hif_rdy, 0x68, 26, 0, 1, PCONF_UNSUPP, 2, 12, PCONF_UNSUPP),
	[RTD1315E_ISO_IR_RX] = RTK_PIN_CONFIG(ir_rx, 0x6c, 7, 1, 2, 0, 3, 4, PADDRI_4_8),
	[RTD1315E_ISO_RESET_N] = RTK_PIN_CONFIG(reset_n, 0x6c, 12, 0, 1, PCONF_UNSUPP, 2, 3, PADDRI_4_8),
	[RTD1315E_ISO_SCAN_SWITCH] = RTK_PIN_CONFIG(scan_switch, 0x6c, 16, PCONF_UNSUPP, PCONF_UNSUPP, 0, 1, 2, PADDRI_4_8),
	[RTD1315E_ISO_TESTMODE] = RTK_PIN_CONFIG(testmode, 0x6c, 19, 0, 1, PCONF_UNSUPP, 2, 3, PADDRI_4_8),
	...
	[RTD1315E_ISO_USB_CC1] = RTK_PIN_CONFIG(usb_cc1, 0x70, 1, PCONF_UNSUPP, PCONF_UNSUPP, 0, 1, 2, PADDRI_4_8),
	[RTD1315E_ISO_USB_CC2] = RTK_PIN_CONFIG(usb_cc2, 0x70, 4, PCONF_UNSUPP, PCONF_UNSUPP, 0, 1, 2, PADDRI_4_8),
...
static const struct rtd_pin_vol_detect_desc rtd1315e_iso_vol_pins[] = {
	RTK_PIN_VOL(uart1, 0x190, 6, 3, "gpio_8", "gpio_9", "gpio_10", "gpio_11"),
	RTK_PIN_VOL(ai, 0x190, 5, 2, "gpio_1", "gpio_6", "gpio_57", "gpio_58", "gpio_59",
		    "gpio_60", "gpio_61", "gpio_62"),
};
...
static const struct rtd_pinctrl_desc rtd1315e_iso_pinctrl_desc = {
	...
	.vol_pins = rtd1315e_iso_vol_pins,
	.num_vol_pins = ARRAY_SIZE(rtd1315e_iso_vol_pins),
};
#endif

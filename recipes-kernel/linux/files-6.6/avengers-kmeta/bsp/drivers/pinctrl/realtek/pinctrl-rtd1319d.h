...
static const struct rtd_pin_vol_detect_desc rtd1319d_iso_vol_pins[] = {
	RTK_PIN_VOL(uart1, 0x190, 6, 3, "gpio_8", "gpio_9", "gpio_10", "gpio_11"),
	RTK_PIN_VOL(sdio, 0x190, 5, 2, "gpio_40", "gpio_41", "gpio_42", "gpio_43", "gpio_44",
		    "gpio_45"),
};
...
static const struct rtd_pinctrl_desc rtd1319d_iso_pinctrl_desc = {
	...
	.vol_pins = rtd1319d_iso_vol_pins,
	.num_vol_pins = ARRAY_SIZE(rtd1319d_iso_vol_pins),
};
#endif

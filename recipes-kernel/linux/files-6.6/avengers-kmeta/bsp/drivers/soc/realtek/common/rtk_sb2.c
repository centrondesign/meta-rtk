...
static const struct sb2_icg_desc sb2_icg_desc_rtd1319d = {
	.offset = 0xff0,
	.num_icg_reg = 4,
	.icg_val = { 0xffffffff, 0xffffffff, 0x0007f7ff, 0xffffffff },
};
...
static const struct of_device_id rtk_sb2_match[] = {
	{ .compatible = "realtek,rtd1295-sysbrg2",  .data = &sb2_icg_desc_rtd1295, },
	{ .compatible = "realtek,rtd1395-sysbrg2",  .data = &sb2_icg_desc_rtd1395, },
	{ .compatible = "realtek,rtd1619-sysbrg2",  .data = &sb2_icg_desc_rtd1619, },
	{ .compatible = "realtek,rtd1319-sysbrg2",  .data = &sb2_icg_desc_rtd1319, },
	{ .compatible = "realtek,rtd1319d-sysbrg2", .data = &sb2_icg_desc_rtd1319d, },
	{}
};

...
static void clk_pll_dif_disable(struct clk_hw *hw)
{
	...
	clk_regmap_update_bits(&pll->clkr, pll->pll_ofs + PLL_ADTV2, 0x00080000, 0x0);
	clk_regmap_update_bits(&pll->clkr, pll->pll_ofs + PLL_ADTV3, 0x00400C03, 0x0);
	clk_regmap_update_bits(&pll->clkr, pll->pll_ofs + PLL_ADTV4, 0x00000038, 0x0);
...
static int clk_pll_dif_v2_enable(struct clk_hw *hw)
{
	...
	case 216000000:
		...
		clk_regmap_write(&pll->clkr, pll->pll_ofs + PLL_ADTV3, 0xd4490903);
	...
	/* improve ifadc */
	clk_regmap_update_bits(&pll->clkr, pll->pll_ofs + PLL_ADTV1, 0x3800, 0x2800);
	clk_regmap_update_bits(&pll->clkr, pll->pll_ofs + PLL_ADTV5, 0x70000, 0x50000);

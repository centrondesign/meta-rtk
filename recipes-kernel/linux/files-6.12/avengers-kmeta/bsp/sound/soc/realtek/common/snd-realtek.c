...
static int snd_monitor_audio_data_queue(void)
{
...
static void snd_realtek_hw_playback_volume_work(struct work_struct *work)
{
...
static void snd_card_remove(struct platform_device *devptr)
{

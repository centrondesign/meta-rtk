...
enum AUDIO_CONFIG_CMD_MSG {
	...
	AUDIO_CONFIG_CMD_LITE_AO_CREATE = 80,
	AUDIO_CONFIG_CMD_LITE_AO_DESTROY = 81,
	AUDIO_CONFIG_CMD_SUBWOOFER_LEVEL_CONTROL = 82,
};
...
enum ENUM_AUTOHARMONY_PARAM_EQUALIZER_COMMAND_TYPE {
	AUDIO_AUTOHARMONY_PARAM_EQ_COMMAND_RELEASE = 0,
	AUDIO_AUTOHARMONY_PARAM_EQ_COMMAND_CREATE,
	AUDIO_AUTOHARMONY_PARAM_EQ_COMMAND_CREATE_SINGLE_CHANNEL,
	AUDIO_AUTOHARMONY_PARAM_EQ_COMMAND_CHANGE_CONFIG,
	AUDIO_AUTOHARMONY_PARAM_EQ_COMMAND_8CH_ENABLE,
	AUDIO_AUTOHARMONY_PARAM_EQ_COMMAND_DMX_ENABLE,
	AUDIO_AUTOHARMONY_PARAM_EQ_COMMAND_MIXING_INDEX_ENABLE,
};

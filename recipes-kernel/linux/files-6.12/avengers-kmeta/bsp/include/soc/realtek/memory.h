...
#define RTK_FLAG_PROTECTED_V2_NPU_PP_POOL                                      \
	(RTK_FLAG_PROTECTED_BITS(RTK_PROTECTED_TYPE_9))
#define RTK_FLAG_PROTECTED_V2_NPU_INFERENCE_POOL                               \
	(RTK_FLAG_PROTECTED_BITS(RTK_PROTECTED_TYPE_10))
#define RTK_FLAG_PROTECTED_V2_NPU_MODEL_POOL                                   \
	(RTK_FLAG_PROTECTED_BITS(RTK_PROTECTED_TYPE_11))
#define RTK_FLAG_PROTECTED_V2_HIFI_POOL                                   \
	(RTK_FLAG_PROTECTED_BITS(RTK_PROTECTED_TYPE_12))

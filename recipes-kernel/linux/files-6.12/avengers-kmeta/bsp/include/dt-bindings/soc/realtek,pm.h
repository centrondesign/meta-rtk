...
#define PCPU_V2_AIOT_MODE (TIMESTAMP | PCTRL | USB | TIMER | GPIO | RTC | LAN)
#define PCPU_V2_AUTO_MODE (TIMESTAMP | PCTRL)
#define PCPU_V2_CHROME_MODE (TIMESTAMP | PCTRL | USB | TIMER | GPIO | RTC)
#define PCPU_V2_STB_MODE (TIMESTAMP | USB | TIMER | GPIO | RTC | LAN | IR | CEC)

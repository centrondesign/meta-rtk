...
struct realtek_irq_mux_data {
	...
	int subset_data_num;
	struct realtek_irq_mux_subset_data subset_data[] __counted_by(subset_data_num);
};
...
enum rtd1635_iso_isr_bits {
	RTD1635_ISO_ISR_TC3_SHIFT =		1,
	RTD1635_ISO_ISR_UR0_SHIFT =		2,
	RTD1635_ISO_ISR_UR9_SHIFT =		3,
	RTD1635_ISO_ISR_SPI0_SHIFT =		4,
	RTD1635_ISO_ISR_SPI1_SHIFT =		5,
	RTD1635_ISO_ISR_SPI2_SHIFT =		6,
	RTD1635_ISO_ISR_SPI3_SHIFT =		7,
	RTD1635_ISO_ISR_I2C0_SHIFT =		8,
	RTD1635_ISO_ISR_TC4_SHIFT =		9,
	RTD1635_ISO_ISR_I2C7_SHIFT =		10,
	RTD1635_ISO_ISR_I2C1_SHIFT =		11,
	RTD1635_ISO_ISR_DRTC_HSEC_SHIFT =	12,
	RTD1635_ISO_ISR_DRTC_MIN_SHIFT =	13,
	RTD1635_ISO_ISR_DRTC_HOUR_SHIFT =	14,
	RTD1635_ISO_ISR_DRTC_DATE_SHIFT =	15,
	RTD1635_ISO_ISR_DRTC_ALARM_SHIFT =	16,
	RTD1635_ISO_ISR_VFD_SHIFT =		17,
	RTD1635_ISO_ISR_I2C8_SHIFT =		18,
	RTD1635_ISO_ISR_GPIOA_SHIFT =		19,
	RTD1635_ISO_ISR_GPIODA_SHIFT =		20,
	RTD1635_ISO_ISR_LSADC0_SHIFT =		21,
	RTD1635_ISO_ISR_LSADC1_SHIFT =		22,
	RTD1635_ISO_ISR_LSADC2_SHIFT =		23,
	RTD1635_ISO_ISR_PORB_HV_CEN_SHIFT =	28,
	RTD1635_ISO_ISR_PORB_DV_CEN_SHIFT =	29,
	RTD1635_ISO_ISR_PORB_AV_CEN_SHIFT =	30,
	RTD1635_ISO_ISR_I2C1_REQ_SHIFT =	31,
};

static const u32 rtd1635_iso_isr_to_scpu_int_en_mask[32] = {
	[RTD1635_ISO_ISR_UR0_SHIFT]		= BIT(2),
	[RTD1635_ISO_ISR_UR9_SHIFT]		= BIT(3),
	[RTD1635_ISO_ISR_SPI0_SHIFT]		= BIT(4),
	[RTD1635_ISO_ISR_SPI1_SHIFT]		= BIT(5),
	[RTD1635_ISO_ISR_SPI2_SHIFT]		= BIT(6),
	[RTD1635_ISO_ISR_SPI3_SHIFT]		= BIT(7),
	[RTD1635_ISO_ISR_I2C0_SHIFT]		= BIT(8),
	[RTD1635_ISO_ISR_I2C7_SHIFT]		= BIT(10),
	[RTD1635_ISO_ISR_I2C1_SHIFT]		= BIT(11),
	[RTD1635_ISO_ISR_DRTC_HSEC_SHIFT]	= BIT(12),
	[RTD1635_ISO_ISR_DRTC_MIN_SHIFT]	= BIT(13),
	[RTD1635_ISO_ISR_DRTC_HOUR_SHIFT]	= BIT(14),
	[RTD1635_ISO_ISR_DRTC_DATE_SHIFT]	= BIT(15),
	[RTD1635_ISO_ISR_DRTC_ALARM_SHIFT]	= BIT(16),
	[RTD1635_ISO_ISR_VFD_SHIFT]		= BIT(17),
	[RTD1635_ISO_ISR_I2C8_SHIFT]		= BIT(18),
	[RTD1635_ISO_ISR_GPIOA_SHIFT]		= BIT(19),
	[RTD1635_ISO_ISR_GPIODA_SHIFT]		= BIT(20),
	[RTD1635_ISO_ISR_LSADC0_SHIFT]		= BIT(21),
	[RTD1635_ISO_ISR_LSADC1_SHIFT]		= BIT(22),
	[RTD1635_ISO_ISR_LSADC2_SHIFT]		= BIT(23),
	[RTD1635_ISO_ISR_PORB_HV_CEN_SHIFT]	= BIT(28),
	[RTD1635_ISO_ISR_PORB_DV_CEN_SHIFT]	= BIT(29),
	[RTD1635_ISO_ISR_PORB_AV_CEN_SHIFT]	= BIT(30),
	[RTD1635_ISO_ISR_I2C1_REQ_SHIFT]	= BIT(31),
};

enum rtd1635_misc_isr_bits {
	RTD1635_ISR_TC8_SHIFT			= 1,
	RTD1635_ISR_TC9_SHIFT			= 2,
	RTD1635_ISR_TC5_SHIFT			= 4,
	RTD1635_ISR_TC0_SHIFT			= 6,
	RTD1635_ISR_TC1_SHIFT			= 7,
	RTD1635_ISR_I2C5_SHIFT			= 14,
	RTD1635_ISR_I2C4_SHIFT			= 15,
	RTD1635_ISR_I2C6_SHIFT			= 22,
	RTD1635_ISR_I2C3_SHIFT			= 23,
	RTD1635_ISR_SC0_SHIFT			= 24,
	RTD1635_ISR_SC1_SHIFT			= 25,
	RTD1635_ISR_FAN_SHIFT			= 29,
};

static const u32 rtd1635_misc_isr_to_scpu_int_en_mask[32] = {
	[RTD1635_ISR_I2C6_SHIFT]		= BIT(13),
	[RTD1635_ISR_I2C5_SHIFT]		= BIT(14),
	[RTD1635_ISR_I2C4_SHIFT]		= BIT(15),
	[RTD1635_ISR_SC0_SHIFT]			= BIT(24),
	[RTD1635_ISR_SC1_SHIFT]			= BIT(25),
	[RTD1635_ISR_I2C3_SHIFT]		= BIT(28),
	[RTD1635_ISR_FAN_SHIFT]			= BIT(29),
};

enum rtd1635_misc_isr2_bits {
	RTD1635_ISR_UR1_SHIFT			= 1,
	RTD1635_ISR_UR2_SHIFT			= 2,
	RTD1635_ISR_UR3_SHIFT			= 3,
	RTD1635_ISR_UR4_SHIFT			= 4,
	RTD1635_ISR_UR5_SHIFT			= 5,
	RTD1635_ISR_UR6_SHIFT			= 6,
	RTD1635_ISR_UR7_SHIFT			= 7,
	RTD1635_ISR_UR8_SHIFT			= 8,
};

static const u32 rtd1635_misc_isr2_to_scpu_int_en_mask[32] = {
	[RTD1635_ISR_UR1_SHIFT]			= BIT(0),
	[RTD1635_ISR_UR2_SHIFT]			= BIT(2),
	[RTD1635_ISR_UR3_SHIFT]			= BIT(4),
	[RTD1635_ISR_UR4_SHIFT]			= BIT(6),
	[RTD1635_ISR_UR5_SHIFT]			= BIT(8),
	[RTD1635_ISR_UR6_SHIFT]			= BIT(10),
	[RTD1635_ISR_UR7_SHIFT]			= BIT(12),
	[RTD1635_ISR_UR8_SHIFT]			= BIT(14),
};

enum rtd1635_isom_isr_bits {
	RTD1635_ISOM_ISR_GPIOA_SHIFT		= 0,
	RTD1635_ISOM_ISR_GPIODA_SHIFT		= 1,
	RTD1635_ISOM_ISR_GPIO_LEVEL		= 2,
	RTD1635_ISOMISR_UR10_SHIFT		= 4,
	RTD1635_ISOMISR_IRDA_SHIFT		= 5,
};

static const u32 rtd1635_isom_isr_to_scpu_int_en_mask[32] = {
	[RTD1635_ISOM_ISR_GPIOA_SHIFT]		= BIT(0),
	[RTD1635_ISOM_ISR_GPIODA_SHIFT]		= BIT(1),
	[RTD1635_ISOM_ISR_GPIO_LEVEL]		= BIT(2),
	[RTD1635_ISOMISR_UR10_SHIFT]		= BIT(4),
	[RTD1635_ISOMISR_IRDA_SHIFT]		= BIT(5),
};
...
static struct realtek_irq_mux_subset_cfg rtd1635_iso_irq_cfgs[] = {
	{ 0xfffe0ff6, },
	{ 0x00000008, }, /* ur9 */
	{ 0x0001f000, }, /* rtc */
};

static const struct realtek_irq_mux_info rtd1635_iso_irq_mux_info = {
	.isr_offset		= 0x0,
	.umsk_isr_offset	= 0x4,
	.scpu_int_en_offset	= 0x40,
	.isr_to_scpu_int_en_mask = rtd1635_iso_isr_to_scpu_int_en_mask,
	.cfg = rtd1635_iso_irq_cfgs,
	.cfg_num = ARRAY_SIZE(rtd1635_iso_irq_cfgs),
};

static struct realtek_irq_mux_subset_cfg rtd1635_misc_irq_cfgs[] = {
	{ 0xfffffffe, },
};

static const struct realtek_irq_mux_info rtd1635_misc_irq_mux_info = {
	.umsk_isr_offset	= 0x8,
	.isr_offset		= 0xc,
	.scpu_int_en_offset	= 0x80,
	.isr_to_scpu_int_en_mask = rtd1635_misc_isr_to_scpu_int_en_mask,
	.cfg = rtd1635_misc_irq_cfgs,
	.cfg_num = ARRAY_SIZE(rtd1635_misc_irq_cfgs),
};

static struct realtek_irq_mux_subset_cfg rtd1635_misc_irq2_cfgs[] = {
	{ 0xfffffff8, },
	{ 0x00000002, }, /* ur1 */
	{ 0x00000004, }, /* ur2 */
};

static const struct realtek_irq_mux_info rtd1635_misc_irq2_mux_info = {
	.umsk_isr_offset	= 0x4,
	.isr_offset		= 0x4,
	.scpu_int_en_offset	= 0x88,
	.scpu_int_en_we		= true,
	.isr_to_scpu_int_en_mask = rtd1635_misc_isr2_to_scpu_int_en_mask,
	.cfg = rtd1635_misc_irq2_cfgs,
	.cfg_num = ARRAY_SIZE(rtd1635_misc_irq2_cfgs),
};

static struct realtek_irq_mux_subset_cfg rtd1635_isom_irq_cfgs[] = {
	{ 0x00000037 },
};

static const struct realtek_irq_mux_info rtd1635_isom_irq_mux_info = {
	.umsk_isr_offset	= 0x4,
	.isr_offset		= 0x0,
	.scpu_int_en_offset	= 0x10,
	.isr_to_scpu_int_en_mask = rtd1635_isom_isr_to_scpu_int_en_mask,
	.cfg = rtd1635_isom_irq_cfgs,
	.cfg_num = ARRAY_SIZE(rtd1635_isom_irq_cfgs),
};
...
static const struct of_device_id realtek_irq_mux_dt_matches[] = {
	{
		...
		.compatible = "realtek,rtd1635-iso-irq-mux",
		.data = &rtd1635_iso_irq_mux_info,
	}, {
		.compatible = "realtek,rtd1635-misc-irq-mux",
		.data = &rtd1635_misc_irq_mux_info,
	}, {
		.compatible = "realtek,rtd1635-misc-irq2-mux",
		.data = &rtd1635_misc_irq2_mux_info,
	}, {
		.compatible = "realtek,rtd1635-isom-irq-mux",
		.data = &rtd1635_isom_irq_mux_info,
	},
	{ /* sentinel */ }
};

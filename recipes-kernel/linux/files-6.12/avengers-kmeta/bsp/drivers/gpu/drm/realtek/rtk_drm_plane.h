...
void rtk_plane_atomic_plane_destroy_state(struct drm_plane *plane, struct drm_plane_state *state);
struct drm_plane_state *rtk_plane_atomic_plane_duplicate_state(struct drm_plane *plane);

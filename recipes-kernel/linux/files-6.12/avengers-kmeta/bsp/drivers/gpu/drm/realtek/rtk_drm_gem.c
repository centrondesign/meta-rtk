...
static struct sg_table *rtk_gem_prime_get_sg_table(struct drm_gem_object *obj)
{
...
static void rtk_gem_free_object(struct drm_gem_object *gem_obj)
{
	struct drm_device *drm = gem_obj->dev;
	struct rtk_gem_object *rtk_obj = to_rtk_gem_obj(gem_obj);
...
static int rtk_gem_prime_vmap(struct drm_gem_object *gem_obj, struct iosys_map *map)
{
	struct rtk_gem_object *rtk_obj = to_rtk_gem_obj(gem_obj);
...
static void rtk_gem_prime_vunmap(struct drm_gem_object *gem_obj, struct iosys_map *map)
{
    /* Nothing to do */
}

...
struct rtk_drm_private {
	 ...
	 * @rpc_info:
	 *
	 * rpc_info[0]=ACPU   when ACPU   only
	 * rpc_info[0]=HIFI   when HIFI   only
	 * rpc_info[0]=RISC-V when RISC-V only
	 * rpc_info[0]=ACPU,   rpc_info[1]=HIFI when ACPU   + HIFI
	 * rpc_info[0]=RISC-V, rpc_info[1]=HIFI when RISC-V + HIFI
	 */
...
extern struct platform_driver rtk_prince_dptx_driver;

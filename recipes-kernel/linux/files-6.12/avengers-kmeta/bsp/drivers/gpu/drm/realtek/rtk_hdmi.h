...
/* Force HDMI mode for EDID not support HDMI */
#define RTK_EDID_QUIRK_HDMI_MODE		(1 << 10)
...
enum VIDEO_ID_CODE {
	...
	VIC_2560x1600P60RB = 0x0000404c,
	VIC_2560x1600P60   = 0x0000404d,
};
...
static const struct rtk_dmt_info {
	int dmt_id;
	struct drm_display_mode rtk_dmt_modes;
} rtk_dmt_info_list[] __attribute__((unused)) = {
...
} rtk_ovt_info_list[] __attribute__((unused)) = {

...
static void rtk_cvbs_conn_destroy(struct drm_connector *connector)
{
	...
	dev_info(cvbs->dev, "conn destroy");
				...
				struct drm_connector_state *conn_state)
{
	...
	dev_info(cvbs->dev, "atomic check");
...
static void rtk_cvbs_remove(struct platform_device *pdev)
{

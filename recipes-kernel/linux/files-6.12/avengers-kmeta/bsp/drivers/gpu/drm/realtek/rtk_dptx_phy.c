...
void rtk_dptx_phy_config_aphy(struct rtk_dptx *dptx)
{
	...
	if (dptx->link_rate == DP_LINK_RATE_1_62) {
		...
		rtk_dptx14_aphy_update(dptx, 0x0b4,
			REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L0_mask
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L1_mask
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L2_mask
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L3_mask,
			REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L0(0)
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L1(0)
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L2(0)
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L3(0));
		...
		rtk_dptx14_aphy_update(dptx, 0x0b4,
			...
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L2_mask
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L3_mask,
			REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L0(1)
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L1(1)
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L2(1)
			| REG_U3DP_f0b4_dp_REG_TX_DDC_EN_L3(1));
	}
}
...
static void rtk_dptx_ssc_setting(struct rtk_dptx *dptx)
{
	...
	case DP_LINK_RATE_8_1:
		...
		break;
	default:
		dev_err(dptx->dev, "[%s] Unsupport link rate!\n", __func__);
		break;
	}
...
static void rtk_dptx_audio_set_info(struct rtk_dptx *dptx, uint16_t sample_freq,

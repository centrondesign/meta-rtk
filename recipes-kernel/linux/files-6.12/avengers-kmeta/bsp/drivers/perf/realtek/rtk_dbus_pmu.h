...
/*
 * The overflow and interrupt control bits are in different order on different
 * RTK SoC.
 */
enum {
	RTK_DBUS_BIT_ORDER_V1 = 0,
	RTK_DBUS_BIT_ORDER_V2 = 1,
};
...
#define DBUS_SYSH_WR_LAT_FULL_COUNT	0x11111111
#define DBUS_SYS_WR_LAT_FULL_COUNT	0x111

...
#define GPU_ID		0x05		/* channel 4, GPU, 2DGPU */
#define SCPU_ID		0x06		/* channel 5, SCPU */
#define VE3_ID		0x09
#define VCPU_ID		0x0a
#define VE2_ID		0x0b
#define MALI_ID		0x0c		/* GPU */
#define GPU_2D_ID	0x0d		/* 2DGPU */
#define SCPU2_ID	0x0e		/* channel 6, SCPU */
...
DDRC_EVENT_GROUP(ve3,	VE3_ID);
DDRC_EVENT_GROUP(mali,	MALI_ID);
DDRC_EVENT_GROUP(gpu_2d,	GPU_2D_ID);
DDRC_EVENT_GROUP(scpu2,	SCPU2_ID);
...
static struct attribute *rtk_13xxd_ddrc_event_attrs[] = {
	DDRC_DRV_EVENT_REF(ddrc_refresh),
	DDRC_DRV_EVENT_REF(ddrc_overflow),
...
static struct attribute *rtk_1625_ddrc_event_attrs[] = {
	DDRC_DRV_EVENT_REF(ddrc_refresh),
	DDRC_DRV_EVENT_REF(ddrc_overflow),
	...
	DDRC_EVENT_REF_GROUP(gpu),
	DDRC_EVENT_REF_GROUP(scpu),
	DDRC_EVENT_REF_GROUP(scpu2),
	DDRC_EVENT_REF_GROUP(vcpu),
	DDRC_EVENT_REF_GROUP(ve2),
	DDRC_EVENT_REF_GROUP(ve3),
	DDRC_EVENT_REF_GROUP(mali),
	DDRC_EVENT_REF_GROUP(gpu_2d),
...
static struct attribute *rtk_1635_ddrc_event_attrs[] = {
	DDRC_DRV_EVENT_REF(ddrc_refresh),
	DDRC_DRV_EVENT_REF(ddrc_overflow),
...
static struct attribute_group rtk_13xxd_ddrc_event_attr_group = {
	.name = "events",
	.attrs = rtk_13xxd_ddrc_event_attrs,
};

static struct attribute_group rtk_1625_ddrc_event_attr_group = {
	.name = "events",
	.attrs = rtk_1625_ddrc_event_attrs,
};

static struct attribute_group rtk_1635_ddrc_event_attr_group = {
	.name = "events",
	.attrs = rtk_1635_ddrc_event_attrs,
};
...
static const struct attribute_group *rtk_13xxd_ddrc_attr_groups[] = {
	/* must be Null-terminated */
	[RTK_PMU_ATTR_GROUP__COMMON] = &rtk_pmu_common_attr_group,
	[RTK_PMU_ATTR_GROUP__FORMAT] = &rtk_ddrc_format_attr_group,
	[RTK_PMU_ATTR_GROUP__EVENT] = &rtk_13xxd_ddrc_event_attr_group,
	[RTK_PMU_ATTR_GROUP__NUM] = NULL
};

static const struct attribute_group *rtk_1625_ddrc_attr_groups[] = {
	/* must be Null-terminated */
	[RTK_PMU_ATTR_GROUP__COMMON] = &rtk_pmu_common_attr_group,
	[RTK_PMU_ATTR_GROUP__FORMAT] = &rtk_ddrc_format_attr_group,
	[RTK_PMU_ATTR_GROUP__EVENT] = &rtk_1625_ddrc_event_attr_group,
	[RTK_PMU_ATTR_GROUP__NUM] = NULL
};

static const struct attribute_group *rtk_1635_ddrc_attr_groups[] = {
	/* must be Null-terminated */
	[RTK_PMU_ATTR_GROUP__COMMON] = &rtk_pmu_common_attr_group,
	[RTK_PMU_ATTR_GROUP__FORMAT] = &rtk_ddrc_format_attr_group,
	[RTK_PMU_ATTR_GROUP__EVENT] = &rtk_1635_ddrc_event_attr_group,
	[RTK_PMU_ATTR_GROUP__NUM] = NULL
};
...
static const unsigned int rtk_13xxd_ddrc_clients[] = {
	RT_ID, NRT_ID, CH3_ID, GPU_ID, SCPU_ID, VCPU_ID, VE2_ID
};

static const unsigned int rtk_1625_ddrc_clients[] = {
	RT_ID, NRT_ID, NPU_ID, CH3_ID, GPU_ID, SCPU_ID, SCPU2_ID, VCPU_ID,
	VE2_ID, VE3_ID, MALI_ID, GPU_2D_ID
};

static const unsigned int rtk_1635_ddrc_clients[] = {
	RT_ID, NRT_ID, NPU_ID, CH3_ID, GPU_ID, SCPU_ID, VCPU_ID,
	VE2_ID, VE3_ID, MALI_ID, GPU_2D_ID
};
...
static const struct rtk_pmc_set_meta rtk_16xxb_ddrc_ps_meta[] = {
	{
...
static const struct rtk_pmc_set_meta rtk_13xxd_ddrc_ps_meta[] = {
	{
		.name = "13xxd DDRC Total",
		.compatible = "ddrc-total",
		.type = PMC_SET__DDRC_TOTAL,
		.init = rtk_ddrc_ps_total_init,
		.group_size = 1,	/* direct map */
	...
	},
	{
		...
		.nr_clients = ARRAY_SIZE(rtk_13xxd_ddrc_clients),
		.nr_pmcgs = ARRAY_SIZE(rtk_16xxb_ddrc_pmcgs) - 1,
		.nr_configs = ARRAY_SIZE(rtk_16xxb_ddrc_configs),
		.clients = rtk_13xxd_ddrc_clients,
		.pmcgs = rtk_16xxb_ddrc_pmcgs,
		.configs = rtk_16xxb_ddrc_configs,
	},
	{
...
static const struct rtk_pmc_set_meta rtk_1625_ddrc_ps_meta[] = {
	{
		.name = "1625 DDRC Total",
		.compatible = "ddrc-total",
		.type = PMC_SET__DDRC_TOTAL,
		.init = rtk_ddrc_ps_total_init,
		.group_size = 1,	/* direct map */
	...
	},
	{
		...
		.nr_clients = ARRAY_SIZE(rtk_1625_ddrc_clients),
		.nr_pmcgs = ARRAY_SIZE(rtk_16xxb_ddrc_pmcgs) - 1,
		.nr_configs = ARRAY_SIZE(rtk_16xxb_ddrc_configs),
		.clients = rtk_1625_ddrc_clients,
		.pmcgs = rtk_16xxb_ddrc_pmcgs,
		.configs = rtk_16xxb_ddrc_configs,
	},
	{
...
static const struct rtk_pmc_set_meta rtk_1635_ddrc_ps_meta[] = {
	{
		.name = "1635 DDRC Total",
		.compatible = "ddrc-total",
		.type = PMC_SET__DDRC_TOTAL,
		.init = rtk_ddrc_ps_total_init,
		.group_size = 1,	/* direct map */
	...
	},
	{
		...
		.nr_clients = ARRAY_SIZE(rtk_1635_ddrc_clients),
		.nr_pmcgs = ARRAY_SIZE(rtk_16xxb_ddrc_pmcgs) - 1,
		.nr_configs = ARRAY_SIZE(rtk_16xxb_ddrc_configs),
		.clients = rtk_1635_ddrc_clients,
		.pmcgs = rtk_16xxb_ddrc_pmcgs,
		.configs = rtk_16xxb_ddrc_configs,
	},
	{
...
release:
	...
	dev_err(dev, "migrate %llx from %d to %d failed\n", event->attr.config, ev.core, cidx);
...
int rtk_13xxd_ddrc_init(struct rtk_pmu *pmu, struct device_node *dt)
{
	int ret;
	...
	ret = rtk_ddrc_pmu_init(pmu, dt,
				 "rtk_13xxd_ddrc_pmu",
				 _DDRC_CTRL_OFFSET_,
				 rtk_13xxd_ddrc_attr_groups,
				 rtk_13xxd_ddrc_ps_meta,
				 RTK_PMU_META_NR(rtk_13xxd_ddrc_ps_meta));
...
EXPORT_SYMBOL(rtk_13xxd_ddrc_init);

int rtk_1625_ddrc_init(struct rtk_pmu *pmu, struct device_node *dt)
{
	int ret;
	...
	ret = rtk_ddrc_pmu_init(pmu, dt,
				 "rtk_1625_ddrc_pmu",
				 _DDRC_CTRL_OFFSET_,
				 rtk_1625_ddrc_attr_groups,
				 rtk_1625_ddrc_ps_meta,
				 RTK_PMU_META_NR(rtk_1625_ddrc_ps_meta));
...
EXPORT_SYMBOL(rtk_1625_ddrc_init);

int rtk_1635_ddrc_init(struct rtk_pmu *pmu, struct device_node *dt)
{
	int ret;
	...
	ret = rtk_ddrc_pmu_init(pmu, dt,
				 "rtk_1635_ddrc_pmu",
				 _DDRC_CTRL_OFFSET_,
				 rtk_1635_ddrc_attr_groups,
				 rtk_1635_ddrc_ps_meta,
				 RTK_PMU_META_NR(rtk_1635_ddrc_ps_meta));
...
EXPORT_SYMBOL(rtk_1635_ddrc_init);
MODULE_LICENSE("GPL");

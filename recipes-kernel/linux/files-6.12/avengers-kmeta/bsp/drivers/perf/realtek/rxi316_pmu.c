...
static void rxi316_pmu_enable(struct pmu *pmu)
{
...
static void rxi316_pmu_disable(struct pmu *pmu)
{
	struct rxi316_pmu *rxi316_pmu = to_rxi316_pmu(pmu);
...
MODULE_DEVICE_TABLE(of, rxi316_pmu_of_device_ids);
...
static int rxi316_pmu_device_probe(struct platform_device *pdev)
{
...
static void rxi316_pmu_device_remove(struct platform_device *pdev)
{

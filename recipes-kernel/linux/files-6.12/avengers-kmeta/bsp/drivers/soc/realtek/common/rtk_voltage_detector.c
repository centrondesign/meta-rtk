...
static const struct rtd_volt_detect_desc_info rtd1635_volt_detect_desc[] = {
	RTD_VOL_DETECT_DESC(sd, 0x1a0, 8, 1),
	RTD_VOL_DETECT_DESC(uart1, 0x1a0, 9, 2),
	RTD_VOL_DETECT_DESC(aio, 0x1a0, 10, 3),
	RTD_VOL_DETECT_DESC(emmc, 0x1a0, 11, 4),
};

static const struct rtd_volt_detect_descs rtd1635_volt_detect_descs = {
	.info = rtd1635_volt_detect_desc,
	.num_descs = ARRAY_SIZE(rtd1635_volt_detect_desc),
};
...
static const struct of_device_id rtd_volt_detector_of_matches[] = {
	...
	{ .compatible = "realtek,rtd1635-volt-detector", .data = &rtd1635_volt_detect_descs },
	{ }
};

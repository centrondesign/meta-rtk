...
static int npupp_send_rpc(struct device *dev, struct rtk_krpc_ept_info *krpc_ept_info,
...
static void rtk_npupp_remove(struct platform_device *pdev)
{
	struct device *dev = &pdev->dev;

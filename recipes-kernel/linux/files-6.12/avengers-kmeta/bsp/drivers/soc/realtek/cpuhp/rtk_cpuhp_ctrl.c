...
#ifdef MODULE
static int cpu_device_offline(struct device *dev)
{
	int ret;
...
static int cpu_device_online(struct device *dev)
{
	int ret = 0;
...
#else
#define cpu_device_offline   device_offline
#define cpu_device_online    device_online
#endif

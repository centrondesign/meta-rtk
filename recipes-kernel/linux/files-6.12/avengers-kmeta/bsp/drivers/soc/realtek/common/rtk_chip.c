...
static const struct rtd_soc_revision rtd1635_revisions[] = {
	{ "A00", 0x00000000},
	{ }
};
...
#define RTD1625_PKG_BIGCD 0xC0000000
...
#define CHIP_TYPE_1861B_ABK  (0xB3050003)
#define CHIP_TYPE_1861B_IBP_OLD (0xBB050013)
#define CHIP_TYPE_1861B_IBP  (0xBB0D0013)
#define CHIP_TYPE_1861B_CBE  (0xBF4D0033)
#define CHIP_TYPE_1861B_ABU  (0xB3850003)
#define CHIP_TYPE_1861B_IBV  (0xBB8D0013)
#define CHIP_TYPE_1861B_CBY  (0xBFCD0033)
#define CHIP_TYPE_1861B_ZIBP (0xFB0D0013)
#define CHIP_TYPE_1861B_ZCBE (0xFF4D0033)
#define CHIP_TYPE_1861B_ZIBV (0xFB8D0013)
#define CHIP_TYPE_1861B_ZCBY (0xFFCD0033)
...
#define CHIP_TYPE_1501S_ES (0x3C0000F1)
	...
	if (!ret) {
		...
		case (CHIP_TYPE_1861B_ES):
			return "1861B_ES";
		case (CHIP_TYPE_1861B_ABK):
			return "1861B_AB-K";
		case (CHIP_TYPE_1861B_IBP_OLD):
		case (CHIP_TYPE_1861B_IBP):
			return "1861B_IB-P";
		case (CHIP_TYPE_1861B_CBE):
			return "1861B_CB-E";
		case (CHIP_TYPE_1861B_ABU):
			return "1861B_AB-U";
		case (CHIP_TYPE_1861B_IBV):
			return "1861B_IB-V";
		case (CHIP_TYPE_1861B_CBY):
			return "1861B_CB-Y";
		case (CHIP_TYPE_1861B_ZIBP):
			return "1861B_ZIB-P";
		case (CHIP_TYPE_1861B_ZCBE):
			return "1861B_ZCB-E";
		case (CHIP_TYPE_1861B_ZIBV):
			return "1861B_ZIB-V";
		case (CHIP_TYPE_1861B_ZCBY):
			return "1861B_ZCB-Y";
...
static const char *rtd1635_name(struct device *dev, const struct rtd_soc *s)
{
	u32 bond_id;
	int ret;

#define RTD1635_PKG_MASK  0xC0000000
#define RTD1635_PKG_BIG   0x80000000
#define RTD1635_PKG_SMALL 0x00000000
#define RTD1635_USE_ON_AIOT    0x000000F0

	ret = of_get_bond_id(dev->of_node, &bond_id);
	if (ret) {
		/* read bond_id from otp directly*/
		void __iomem *reg = ioremap(0x98032898, 0x4);
	...
	if (!ret) {
		...
		package_type = bond_id & RTD1635_PKG_MASK;

		/* Note disabling all bits,
		   then this chip is used by aiot
		 */
		is_aiot = ((bond_id & RTD1635_USE_ON_AIOT) == RTD1635_USE_ON_AIOT);

		switch (package_type) {
		case (RTD1635_PKG_BIG):
			if (is_aiot)
				return "RTD1500";
			else
				return "RTD1761";
			break;
		case (RTD1635_PKG_SMALL):
			return "RTD1635";
		default:
			pr_err("%s: Using default chip id (bond_id=0x%x)\n",
				    __func__, bond_id);
...
static const char *rtd1635_chip_type(struct device *dev, const struct rtd_soc *s)
{
	u32 bond_id;
	int ret;

#define CHIP_TYPE_1761_EI    (0x80000000)
#define CHIP_TYPE_1761_ES    (0xB0000001)
#define CHIP_TYPE_1761_ABM   (0xB3080003)
#define CHIP_TYPE_1761_IBQ   (0xBB080003)
#define CHIP_TYPE_1761_IBP   (0xBB0A0003)
#define CHIP_TYPE_1761_CBH   (0xBF4801F3)
#define CHIP_TYPE_1500_EI    (0x8C0000F0)
#define CHIP_TYPE_1500_ES    (0xBC0000F1)
#define CHIP_TYPE_1500_CBG   (0xBF4001F3)
#define CHIP_TYPE_1500_CBN   (0xBF5F07F3)
#define CHIP_TYPE_1635_EI    (0x0C040000)
#define CHIP_TYPE_1635_ES    (0x3C040001)
#define CHIP_TYPE_1635_PBG   (0x3F440003)
#define CHIP_TYPE_1635_PCG   (0x3E440003)
#define CHIP_TYPE_1635_PVG   (0x3C440003)
	...
	if (!ret) {
		dev_info(dev, "bond_id: 0x%08x\n", bond_id);
		switch (bond_id) {
			case (CHIP_TYPE_1761_EI):
			return "1761_EI";
			case (CHIP_TYPE_1761_ES):
			return "1761_ES";
			case (CHIP_TYPE_1761_ABM):
			return "1761_ABM";
			case (CHIP_TYPE_1761_IBQ):
			return "1761_IBQ";
			case (CHIP_TYPE_1761_IBP):
			return "1761_IBP";
			case (CHIP_TYPE_1761_CBH):
			return "1761_CBH";
			case (CHIP_TYPE_1500_EI):
			return "1500_EI";
			case (CHIP_TYPE_1500_ES):
			return "1500_ES";
			case (CHIP_TYPE_1500_CBG):
			return "1500_CBG";
			case (CHIP_TYPE_1500_CBN):
			return "1500_CBN";
			case (CHIP_TYPE_1635_EI):
			return "1635_EI";
			case (CHIP_TYPE_1635_ES):
			return "1635_ES";
			case (CHIP_TYPE_1635_PBG):
			return "1635_PBG";
			case (CHIP_TYPE_1635_PCG):
			return "1635_PCG";
			case (CHIP_TYPE_1635_PVG):
			return "1635_PVG";
		default:
			pr_err("%s: Not define chip type 0x%x\n",
				    __func__, bond_id);
...
static const char *rtd1635_get_codename(struct device *dev)
{
	return "Prince";
}
...
static const struct rtd_soc rtd_soc_families[] = {
	...
	{ 0x00007046, rtd1635_name, rtd1635_chip_type, rtd1635_revisions, rtd1635_get_codename },
};
...
static void rtd_soc_remove(struct platform_device *pdev)
{

...
#include <soc/realtek/rtk_sw_sync.h>

#define CREATE_TRACE_POINTS
#include <trace/events/rtk_sync_trace.h>
 ...
 * case of error.
 */
static struct rtk_sync_timeline *rtk_sync_timeline_create(const char *name)
{
...
static void rtk_sync_timeline_put(struct rtk_sync_timeline *obj)
{
 ...
 */
static void rtk_sync_timeline_signal(struct rtk_sync_timeline *obj, unsigned int inc)
{
 ...
 */
static struct rtk_sync_pt *rtk_sync_pt_create(struct rtk_sync_timeline *obj,
				      unsigned int value)
{

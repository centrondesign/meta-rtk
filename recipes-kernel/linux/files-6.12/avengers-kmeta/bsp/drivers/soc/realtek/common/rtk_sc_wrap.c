...
static void rtd1319d_sc_wrap_setup_icg(struct sc_wrap_data *data)
{
	uint32_t val;
	...
	val = readl(data->base + ICG_EN);
	val |= 0x0000010b;
	writel(val, data->base + ICG_EN);
}

static const struct sc_wrap_ops rtd1319d_sc_wrap_ops = {
	.setup_icg = rtd1319d_sc_wrap_setup_icg,
};
...
static const struct of_device_id sc_wrap_ids[] = {
	...
	{ .compatible = "realtek,rtd1319d-scpu-wrapper", .data = &rtd1319d_sc_wrap_ops, },
	{}
};

...
static long rtk_fwdbg_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
...
static int rtk_fwdbg_open(struct inode *inode, struct file *filp)
{
...
static void rtk_fwdbg_remove(struct platform_device *pdev)
{
	if (!fwdbg_ctl)
		return;

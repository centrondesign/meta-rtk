...
#define DPHY_HL_INTERVAL_DEFAULT  0xE
#define DPHY_HL_INTERVAL_MAX_KENT   0xF
#define DPHY_HL_INTERVAL_MAX_PRINCE 0xFF
...
#define KENT_ISO_SYS_PWR_CTR    0x300

#define RTK_V4L2_CID_MIPI_COMPENC       (V4L2_CID_PRIVATE_BASE + 0)
#define RTK_V4L2_CID_MIPI_MIRROR        (V4L2_CID_PRIVATE_BASE + 1)
#define RTK_V4L2_CID_MIPI_STOP_RESTART  (V4L2_CID_PRIVATE_BASE + 2)
...
struct rtk_mipicsi_ops {
	...
	int (*prbs_check)(struct rtk_mipicsi *mipicsi, u8 chk_mod);
};
...
#define PRBS7_LANE0  0x00
#define PRBS7_LANE1  0x01
#define PRBS7_LANE2  0x02
#define PRBS7_LANE3  0x03
#define PRBS9_LANE0  0x04
#define PRBS9_LANE1  0x05
#define PRBS9_LANE2  0x06
#define PRBS9_LANE3  0x07
...
enum rtk_streaming_state {
	STREAM_STATE_IDLE = 0,
	STREAM_STATE_CAPTURING,
	STREAM_STATE_STOP,
};

/* struct rtk_mipicsi swap_config Bit[12:8] for APHY_REG43 */
#define FLAG_NO_LANE_SWAP   (0x0000)
#define FLAG_LANE_CK_SWAP   (0x1000)
#define FLAG_LANE_3_SWAP    (0x0800)
#define FLAG_LANE_2_SWAP    (0x0400)
#define FLAG_LANE_1_SWAP    (0x0200)
#define FLAG_LANE_0_SWAP    (0x0100)
#define FLAG_ALL_LANE_SWAP  (0x1F00)

/* struct rtk_mipicsi swap_config Bit[7:0] for DPHY_LANE_SEL */
#define SWAP_SEQ_LANE_0_1_2_3 (0xE4)
#define SWAP_SEQ_LANE_3_1_2_0 (0x27)
#define SWAP_SEQ_LANE_1_0_2_3 (0xE1)
#define SWAP_SEQ_LANE_3_0_2_1 (0x2D)
#define SWAP_SEQ_LANE_0_3_2_1 (0x6C)
#define SWAP_SEQ_LANE_1_3_2_0 (0x63)
#define SWAP_SEQ_LANE_0_2_1_3 (0xD8)
#define SWAP_SEQ_LANE_3_2_1_0 (0x1B)
#define SWAP_SEQ_LANE_2_0_1_3 (0xC9)
#define SWAP_SEQ_LANE_3_0_1_2 (0x39)
#define SWAP_SEQ_LANE_0_3_1_2 (0x78)
#define SWAP_SEQ_LANE_2_3_1_0 (0x4B)
#define SWAP_SEQ_LANE_2_1_0_3 (0xC6)
#define SWAP_SEQ_LANE_3_1_0_2 (0x36)
#define SWAP_SEQ_LANE_1_2_0_3 (0xD2)
#define SWAP_SEQ_LANE_3_2_0_1 (0x1E)
#define SWAP_SEQ_LANE_2_3_0_1 (0x4E)
#define SWAP_SEQ_LANE_1_3_0_2 (0x72)
#define SWAP_SEQ_LANE_0_1_3_2 (0xB4)
#define SWAP_SEQ_LANE_2_1_3_0 (0x87)
#define SWAP_SEQ_LANE_1_0_3_2 (0xB1)
#define SWAP_SEQ_LANE_2_0_3_1 (0x8D)
#define SWAP_SEQ_LANE_0_2_3_1 (0x9C)
#define SWAP_SEQ_LANE_1_2_3_0 (0x93)
...
struct rtk_mipicsi {
	...
	enum rtk_streaming_state stream_state;
	u32 sequence;
	u8 mode;
	u32 skew_mode;
	u32 mirror_mode;

...
#define VI_CASCADE_ch4_id_shift              (28)
#define VI_CASCADE_ch4_id_mask               (0xF0000000)
#define VI_CASCADE_ch4_id(data)              (0xF0000000&((data)<<28))
#define VI_CASCADE_ch4_id_src(data)          ((0xF0000000&(data))>>28)
#define VI_CASCADE_get_ch4_id(data)          ((0xF0000000&(data))>>28)
//this->default: VI_CASCADE_ch4_id           0x0
#define VI_CASCADE_ch3_id_shift              (24)
#define VI_CASCADE_ch3_id_mask               (0x0F000000)
#define VI_CASCADE_ch3_id(data)              (0x0F000000&((data)<<24))
#define VI_CASCADE_ch3_id_src(data)          ((0x0F000000&(data))>>24)
#define VI_CASCADE_get_ch3_id(data)          ((0x0F000000&(data))>>24)
//this->default: VI_CASCADE_ch3_id           0x0
...
#define VI_CASCADE_proc_ch_num_shift          (6)
#define VI_CASCADE_proc_ch_num_mask           (0x40)
#define VI_CASCADE_proc_ch_num(data)          (0x40&((data)<<6))
#define VI_CASCADE_proc_ch_num_src(data)      ((0x40&(data))>>6)
#define VI_CASCADE_get_proc_ch_num(data)      ((0x40&(data))>>6)
//this->default: VI_CASCADE_proc_ch_num           0x0
...
/* Prince MAC */
#define P_VI_FC                     (0x000)
#define P_VI_CASCADE                (0x00C)
#define P_VI_DMA                    (0x010)
#define P_VI_SCPU_INTEN0            (0x060)
#define P_VI_SCPU_INTEN1            (0x064)
#define P_VI_SCPU_INTEN2            (0x068)
#define P_VI_SCPU_INTEN3            (0x06C)
#define P_VI_SCPU_INTEN4            (0x070)
#define P_VI_SCPU_INTEN5            (0x074)
#define P_VI_SCPU_INTEN6            (0x078)
#define P_VI_SCPU_INTEN7            (0x07C)
#define P_VI_SCPU_INTEN8            (0x080)

#define VI_SCPU_INTEN0_ecc_3_shift              (29)
#define VI_SCPU_INTEN0_ecc_3_mask               (0x20000000)
#define VI_SCPU_INTEN0_ecc_3(data)              (0x20000000&((data)<<29))
#define VI_SCPU_INTEN0_ecc_3_src(data)          ((0x20000000&(data))>>29)
#define VI_SCPU_INTEN0_get_ecc_3(data)          ((0x20000000&(data))>>29)
//this->default: VI_SCPU_INTEN0_ecc_3           0x0
#define VI_SCPU_INTEN0_vanc_fifo_3_shift        (28)
#define VI_SCPU_INTEN0_vanc_fifo_3_mask         (0x10000000)
#define VI_SCPU_INTEN0_vanc_fifo_3(data)        (0x10000000&((data)<<28))
#define VI_SCPU_INTEN0_vanc_fifo_3_src(data)    ((0x10000000&(data))>>28)
#define VI_SCPU_INTEN0_get_vanc_fifo_3(data)    ((0x10000000&(data))>>28)
//this->default: VI_SCPU_INTEN0_vanc_fifo_3     0x0
#define VI_SCPU_INTEN0_data_fifo_3_shift        (27)
#define VI_SCPU_INTEN0_data_fifo_3_mask         (0x08000000)
#define VI_SCPU_INTEN0_data_fifo_3(data)        (0x08000000&((data)<<27))
#define VI_SCPU_INTEN0_data_fifo_3_src(data)    ((0x08000000&(data))>>27)
#define VI_SCPU_INTEN0_get_data_fifo_3(data)    ((0x08000000&(data))>>27)
//this->default: VI_SCPU_INTEN0_data_fifo_3     0x0
#define VI_SCPU_INTEN0_bt_3_pdi_shift           (26)
#define VI_SCPU_INTEN0_bt_3_pdi_mask            (0x04000000)
#define VI_SCPU_INTEN0_bt_3_pdi(data)           (0x04000000&((data)<<26))
#define VI_SCPU_INTEN0_bt_3_pdi_src(data)       ((0x04000000&(data))>>26)
#define VI_SCPU_INTEN0_get_bt_3_pdi(data)       ((0x04000000&(data))>>26)
//this->default: VI_SCPU_INTEN0_bt_3_pdi        0x0
#define VI_SCPU_INTEN0_ecc_2_shift              (24)
#define VI_SCPU_INTEN0_ecc_2_mask               (0x01000000)
#define VI_SCPU_INTEN0_ecc_2(data)              (0x01000000&((data)<<24))
#define VI_SCPU_INTEN0_ecc_2_src(data)          ((0x01000000&(data))>>24)
#define VI_SCPU_INTEN0_get_ecc_2(data)          ((0x01000000&(data))>>24)
//this->default: VI_SCPU_INTEN0_ecc_2           0x0
#define VI_SCPU_INTEN0_vanc_fifo_2_shift        (23)
#define VI_SCPU_INTEN0_vanc_fifo_2_mask         (0x00800000)
#define VI_SCPU_INTEN0_vanc_fifo_2(data)        (0x00800000&((data)<<23))
#define VI_SCPU_INTEN0_vanc_fifo_2_src(data)    ((0x00800000&(data))>>23)
#define VI_SCPU_INTEN0_get_vanc_fifo_2(data)    ((0x00800000&(data))>>23)
//this->default: VI_SCPU_INTEN0_vanc_fifo_2     0x0
#define VI_SCPU_INTEN0_data_fifo_2_shift        (22)
#define VI_SCPU_INTEN0_data_fifo_2_mask         (0x00400000)
#define VI_SCPU_INTEN0_data_fifo_2(data)        (0x00400000&((data)<<22))
#define VI_SCPU_INTEN0_data_fifo_2_src(data)    ((0x00400000&(data))>>22)
#define VI_SCPU_INTEN0_get_data_fifo_2(data)    ((0x00400000&(data))>>22)
//this->default: VI_SCPU_INTEN0_data_fifo_2     0x0
#define VI_SCPU_INTEN0_bt_2_pdi_shift           (21)
#define VI_SCPU_INTEN0_bt_2_pdi_mask            (0x00200000)
#define VI_SCPU_INTEN0_bt_2_pdi(data)           (0x00200000&((data)<<21))
#define VI_SCPU_INTEN0_bt_2_pdi_src(data)       ((0x00200000&(data))>>21)
#define VI_SCPU_INTEN0_get_bt_2_pdi(data)       ((0x00200000&(data))>>21)
//this->default: VI_SCPU_INTEN0_bt_2_pdi        0x0
#define P_VI_INTST0                 (0x0A8)
#define VI_INTST0_wb_adr_3_shift           (30)
#define VI_INTST0_wb_adr_3_mask            (0x40000000)
#define VI_INTST0_get_wb_adr_3(data)       ((0x40000000&(data))>>30)
#define VI_INTST0_ecc_3_shift              (29)
#define VI_INTST0_ecc_3_mask               (0x20000000)
#define VI_INTST0_vanc_fifo_3_shift        (28)
#define VI_INTST0_vanc_fifo_3_mask         (0x10000000)
#define VI_INTST0_data_fifo_3_shift        (27)
#define VI_INTST0_data_fifo_3_mask         (0x08000000)
#define VI_INTST0_bt_3_pdi_shift           (26)
#define VI_INTST0_bt_3_pdi_mask            (0x04000000)
#define VI_INTST0_wb_adr_2_shift           (25)
#define VI_INTST0_wb_adr_2_mask            (0x02000000)
#define VI_INTST0_get_wb_adr_2(data)       ((0x02000000&(data))>>25)
#define VI_INTST0_ecc_2_shift              (24)
#define VI_INTST0_ecc_2_mask               (0x01000000)
#define VI_INTST0_vanc_fifo_2_shift        (23)
#define VI_INTST0_vanc_fifo_2_mask         (0x00800000)
#define VI_INTST0_data_fifo_2_shift        (22)
#define VI_INTST0_data_fifo_2_mask         (0x00400000)
#define VI_INTST0_bt_2_pdi_shift           (21)
#define VI_INTST0_bt_2_pdi_mask            (0x00200000)

#define VI_INTST0_ch3_err_mask \
	(VI_INTST0_wb_adr_3_mask | \
	VI_INTST0_ecc_3_mask | \
	VI_INTST0_vanc_fifo_3_mask | \
	VI_INTST0_data_fifo_3_mask)
#define VI_INTST0_ch3_mask    (VI_INTST0_bt_3_pdi_mask | VI_INTST0_ch3_err_mask)

#define VI_INTST0_ch2_err_mask \
	(VI_INTST0_wb_adr_2_mask | \
	VI_INTST0_ecc_2_mask | \
	VI_INTST0_vanc_fifo_2_mask | \
	VI_INTST0_data_fifo_2_mask)
#define VI_INTST0_ch2_mask    (VI_INTST0_bt_2_pdi_mask | VI_INTST0_ch2_err_mask)

#define P_VI_INTST1                 (0x0AC)
#define P_VI_INTST2                 (0x0B0)
#define P_VI_INTST3                 (0x0B4)
#define P_VI_INTST4                 (0x0B8)
#define P_VI_INTST5                 (0x0BC)
#define P_VI_INTST6                 (0x0C0)
#define P_VI_INTST7                 (0x0C4)
#define P_VI_INTST8                 (0x0C8)
#define P_VI_RST_CTRL       	    (0x110)
#define P_VI_CRC_CTRL               (0x114)
#define VI_CRC_CTRL_mac_3_en_shift              (9)
#define VI_CRC_CTRL_mac_3_en_mask               (0x00000200)
#define VI_CRC_CTRL_mac_3_en(data)              (0x00000200&((data)<<9))
#define VI_CRC_CTRL_mac_3_en_src(data)          ((0x00000200&(data))>>9)
#define VI_CRC_CTRL_get_mac_3_en(data)          ((0x00000200&(data))>>9)
#define VI_CRC_CTRL_mac_2_en_shift              (8)
#define VI_CRC_CTRL_mac_2_en_mask               (0x00000100)
#define VI_CRC_CTRL_mac_2_en(data)              (0x00000100&((data)<<8))
#define VI_CRC_CTRL_mac_2_en_src(data)          ((0x00000100&(data))>>8)
#define VI_CRC_CTRL_get_mac_2_en(data)          ((0x00000100&(data))>>8)
#define P_VI_GC                     (0x120)
#define P_VI_DECODER_1              (0x500)
#define P_VI_DECODER_2              (0x800)
#define P_VI_DECODER_3              (0xB00)
#define P_VI_DECODER              	(0x200)
#define P_VI_IMG                  	(0x204)
#define P_VI_IMG_I                	(0x208)
#define P_VI_RAWDATA              	(0x20C)
#define P_VI_VANC                 	(0x210)
#define P_VI_VANC_P               	(0x214)
#define P_VI_VANC_I               	(0x218)
#define P_VI_VANC_SEQ_PITCH       	(0x21C)
#define P_VI_ISP_CFG              	(0x220)
#define P_VI_ISP_SEL              	(0x224)
#define P_VI_ISP_SEQ_PITCH_Y      	(0x228)
#define P_VI_ISP_SEQ_PITCH_C      	(0x22C)
#define P_VI_ISP_VSI              	(0x230)
#define P_VI_ISP_VSD              	(0x234)
#define P_VI_ISP_VSD_H            	(0x238)
#define P_VI_ISP_VSD_TF           	(0x23C)
#define P_VI_ISP_VSD_H_TF         	(0x240)
#define P_VI_ISP_VSD_BF           	(0x244)
#define P_VI_ISP_VSD_H_BF         	(0x248)
#define P_VI_ISP_VSYC_0           	(0x24C)
#define P_VI_ISP_VSYC_1           	(0x250)
#define P_VI_ISP_VSYC_2           	(0x254)
#define P_VI_ISP_VSYC_3           	(0x258)
#define P_VI_ISP_VSYC_4           	(0x25C)
#define P_VI_ISP_VSYC_5           	(0x260)
#define P_VI_ISP_VSYC_6           	(0x264)
#define P_VI_ISP_VSYC_7           	(0x268)
#define P_VI_ISP_VSCC_0           	(0x26C)
#define P_VI_ISP_VSCC_1           	(0x270)
#define P_VI_ISP_VSCC_2           	(0x274)
#define P_VI_ISP_VSCC_3           	(0x278)
#define P_VI_ISP_VSCC_4           	(0x27C)
#define P_VI_ISP_VSCC_5           	(0x280)
#define P_VI_ISP_VSCC_6           	(0x284)
#define P_VI_ISP_VSCC_7           	(0x288)
#define P_VI_ISP_HSI              	(0x28C)
#define P_VI_ISP_HSD              	(0x290)
#define P_VI_ISP_HSD_W            	(0x294)
#define P_VI_ISP_HSYC_0           	(0x298)
#define P_VI_ISP_HSYC_1           	(0x29C)
#define P_VI_ISP_HSYC_2           	(0x2A0)
#define P_VI_ISP_HSYC_3           	(0x2A4)
#define P_VI_ISP_HSYC_4           	(0x2A8)
#define P_VI_ISP_HSYC_5           	(0x2AC)
#define P_VI_ISP_HSYC_6           	(0x2B0)
#define P_VI_ISP_HSYC_7           	(0x2B4)
#define P_VI_ISP_HSYC_8           	(0x2B8)
#define P_VI_ISP_HSYC_9           	(0x2BC)
#define P_VI_ISP_HSYC_10          	(0x2C0)
#define P_VI_ISP_HSYC_11          	(0x2C4)
#define P_VI_ISP_HSYC_12          	(0x2C8)
#define P_VI_ISP_HSYC_13          	(0x2CC)
#define P_VI_ISP_HSYC_14          	(0x2D0)
#define P_VI_ISP_HSYC_15          	(0x2D4)
#define P_VI_ISP_HSCC_0           	(0x2D8)
#define P_VI_ISP_HSCC_1           	(0x2DC)
#define P_VI_ISP_HSCC_2           	(0x2E0)
#define P_VI_ISP_HSCC_3           	(0x2E4)
#define P_VI_ISP_HSCC_4           	(0x2E8)
#define P_VI_ISP_HSCC_5           	(0x2EC)
#define P_VI_ISP_HSCC_6           	(0x2F0)
#define P_VI_ISP_HSCC_7           	(0x2F4)
#define P_VI_BT_PDI_FC            	(0x2F8)
#define P_VI_BT_PDI               	(0x2FC)
#define P_VI_BT_VANC_I            	(0x300)
#define P_VI_BT_TF_IMG            	(0x304)
#define P_VI_BT_BF_IMG            	(0x308)
#define P_VI_BT_VANC_P            	(0x30C)
#define P_VI_BT_P_IMG             	(0x310)
#define P_VI_ADR_ENTRY0_Y_SA      	(0x314)
#define P_VI_ADR_ENTRY0_Y_EA      	(0x318)
#define P_VI_ADR_ENTRY0_C_SA      	(0x31C)
#define P_VI_ADR_ENTRY0_C_EA      	(0x320)
#define P_VI_ADR_ENTRY0_VANC_SA   	(0x324)
#define P_VI_ADR_ENTRY0_VANC_EA   	(0x328)
#define P_VI_ADR_ENTRY0_TF_Y_SA   	(0x32C)
#define P_VI_ADR_ENTRY0_TF_Y_EA   	(0x330)
#define P_VI_ADR_ENTRY0_TF_C_SA   	(0x334)
#define P_VI_ADR_ENTRY0_TF_C_EA   	(0x338)
#define P_VI_ADR_ENTRY0_TF_VANC_SA	(0x33C)
#define P_VI_ADR_ENTRY0_TF_VANC_EA	(0x340)
#define P_VI_ADR_ENTRY0_BF_Y_SA   	(0x344)
#define P_VI_ADR_ENTRY0_BF_Y_EA   	(0x348)
#define P_VI_ADR_ENTRY0_BF_C_SA   	(0x34C)
#define P_VI_ADR_ENTRY0_BF_C_EA   	(0x350)
#define P_VI_ADR_ENTRY0_BF_VANC_SA	(0x354)
#define P_VI_ADR_ENTRY0_BF_VANC_EA	(0x358)
#define P_VI_ADR_ENTRY0_ST        	(0x35C)
#define P_VI_ADR_ENTRY1_Y_SA      	(0x360)
#define P_VI_ADR_ENTRY1_Y_EA      	(0x364)
#define P_VI_ADR_ENTRY1_C_SA      	(0x368)
#define P_VI_ADR_ENTRY1_C_EA      	(0x36C)
#define P_VI_ADR_ENTRY1_VANC_SA   	(0x370)
#define P_VI_ADR_ENTRY1_VANC_EA   	(0x374)
#define P_VI_ADR_ENTRY1_TF_Y_SA   	(0x378)
#define P_VI_ADR_ENTRY1_TF_Y_EA   	(0x37C)
#define P_VI_ADR_ENTRY1_TF_C_SA   	(0x380)
#define P_VI_ADR_ENTRY1_TF_C_EA   	(0x384)
#define P_VI_ADR_ENTRY1_TF_VANC_SA	(0x388)
#define P_VI_ADR_ENTRY1_TF_VANC_EA	(0x38C)
#define P_VI_ADR_ENTRY1_BF_Y_SA   	(0x390)
#define P_VI_ADR_ENTRY1_BF_Y_EA   	(0x394)
#define P_VI_ADR_ENTRY1_BF_C_SA   	(0x398)
#define P_VI_ADR_ENTRY1_BF_C_EA   	(0x39C)
#define P_VI_ADR_ENTRY1_BF_VANC_SA	(0x3A0)
#define P_VI_ADR_ENTRY1_BF_VANC_EA	(0x3A4)
#define P_VI_ADR_ENTRY1_ST        	(0x3A8)
#define P_VI_ADR_ENTRY2_Y_SA      	(0x3AC)
#define P_VI_ADR_ENTRY2_Y_EA      	(0x3B0)
#define P_VI_ADR_ENTRY2_C_SA      	(0x3B4)
#define P_VI_ADR_ENTRY2_C_EA      	(0x3B8)
#define P_VI_ADR_ENTRY2_VANC_SA   	(0x3BC)
#define P_VI_ADR_ENTRY2_VANC_EA   	(0x3C0)
#define P_VI_ADR_ENTRY2_TF_Y_SA   	(0x3C4)
#define P_VI_ADR_ENTRY2_TF_Y_EA   	(0x3C8)
#define P_VI_ADR_ENTRY2_TF_C_SA   	(0x3CC)
#define P_VI_ADR_ENTRY2_TF_C_EA   	(0x3D0)
#define P_VI_ADR_ENTRY2_TF_VANC_SA	(0x3D4)
#define P_VI_ADR_ENTRY2_TF_VANC_EA	(0x3D8)
#define P_VI_ADR_ENTRY2_BF_Y_SA   	(0x3DC)
#define P_VI_ADR_ENTRY2_BF_Y_EA   	(0x3E0)
#define P_VI_ADR_ENTRY2_BF_C_SA   	(0x3E4)
#define P_VI_ADR_ENTRY2_BF_C_EA   	(0x3E8)
#define P_VI_ADR_ENTRY2_BF_VANC_SA	(0x3EC)
#define P_VI_ADR_ENTRY2_BF_VANC_EA	(0x3F0)
#define P_VI_ADR_ENTRY2_ST        	(0x3F4)
#define P_VI_ADR_ENTRY3_Y_SA      	(0x3F8)
#define P_VI_ADR_ENTRY3_Y_EA      	(0x3FC)
#define P_VI_ADR_ENTRY3_C_SA      	(0x400)
#define P_VI_ADR_ENTRY3_C_EA      	(0x404)
#define P_VI_ADR_ENTRY3_VANC_SA   	(0x408)
#define P_VI_ADR_ENTRY3_VANC_EA   	(0x40C)
#define P_VI_ADR_ENTRY3_TF_Y_SA   	(0x410)
#define P_VI_ADR_ENTRY3_TF_Y_EA   	(0x414)
#define P_VI_ADR_ENTRY3_TF_C_SA   	(0x418)
#define P_VI_ADR_ENTRY3_TF_C_EA   	(0x41C)
#define P_VI_ADR_ENTRY3_TF_VANC_SA	(0x420)
#define P_VI_ADR_ENTRY3_TF_VANC_EA	(0x424)
#define P_VI_ADR_ENTRY3_BF_Y_SA   	(0x428)
#define P_VI_ADR_ENTRY3_BF_Y_EA   	(0x42C)
#define P_VI_ADR_ENTRY3_BF_C_SA   	(0x430)
#define P_VI_ADR_ENTRY3_BF_C_EA   	(0x434)
#define P_VI_ADR_ENTRY3_BF_VANC_SA	(0x438)
#define P_VI_ADR_ENTRY3_BF_VANC_EA	(0x43C)
#define P_VI_ADR_ENTRY3_ST        	(0x440)

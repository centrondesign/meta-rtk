...
/* For CEC_RxST */
#define RX_INIT_ADDR_SHIFT	(12)
#define RX_DEST_ADDR_SHIFT	(8)
#define RX_RCVE_ST_SHIFT	(4)

/* For CEC_CR1 */
#define LOG_ADDR0_EN            BIT(16)
#define LOG_ADDR1_EN            BIT(17)
#define LOG_ADDR2_EN            BIT(18)
#define LOG_ADDR3_EN            BIT(19)
#define LOG_ADDR_SEL_SHIFT      (20)
#define LOG_ADDR1_SHIFT         (4)
#define LOG_ADDR2_SHIFT         (8)
#define LOG_ADDR3_SHIFT         (12)
#define LOG_ADDR_SEL_MASK       (0x3 << LOG_ADDR_SEL_SHIFT)
#define LOG_ADDR1_MASK          (0xF << LOG_ADDR1_SHIFT)
#define LOG_ADDR2_MASK          (0xF << LOG_ADDR2_SHIFT)
#define LOG_ADDR3_MASK          (0xF << LOG_ADDR3_SHIFT)

...
/* RTD1625 */
#define RTD1625_RS_DEFAULT		0X3	/* TX */
#define RTD1625_RSW_DEFAULT		0X4	/* RX */
#define RTD1625_IDAC_FINE_MDI_DEFAULT	0X12	/* TX */
#define RTD1625_IDAC_FINE_MDIX_DEFAULT	0X12	/* RX */
...
/* PRINCE */
#define PRINCE_RS_DEFAULT		0X3	/* TX */
#define PRINCE_RSW_DEFAULT		0X4	/* RX */
#define PRINCE_IDAC_FINE_MDI_DEFAULT	0X12	/* TX */
#define PRINCE_IDAC_FINE_MDIX_DEFAULT	0X12	/* RX */

/* MAIN2 misc base addr 0x9804f000 */
enum prince_m2tmx_registers {
	PRINCE_M2TMX_PWRCUT_ETN	= 0x0180,
	PRINCE_M2TMX_ETN_MISC		= 0x0194, /* init_autoload_done */
	PRINCE_M2TMX_ETN_SGPHY_MISC	= 0x0198,
};

/* SDS base addr 0x981c8000 */
enum prince_sds_registers {
	PRINCE_SDS_REG2		= 0x0008,
};

/* SDS DPHY base addr 0x981c9000 */
enum prince_sds_dphy_registers {
	PRINCE_SDS_ANA04		= 0x0010,
	PRINCE_SDS_ANA0B		= 0x002c,
	PRINCE_SDS_ANA0C		= 0x0030,
	PRINCE_SDS_ANA0D		= 0x0034,
	PRINCE_SDS_ANA0E		= 0x0038,
	PRINCE_SDS_ANA0F		= 0x003c,
	PRINCE_SDS_ANA10		= 0x0040,
	PRINCE_SDS_ANA11		= 0x0044,
	PRINCE_SDS_ANA25		= 0x0094,
};

/* SDS regif base addr 0x981c9800 */
enum prince_sdsif_reg_registers {
	PRINCE_SDS_MISC		= 0x0004,
	PRINCE_SDS_LINK		= 0x000c,
};
...
struct rtl8169_private {
	...
	struct regmap *sds_dphy_base;
	struct regmap *sds_regif_base;

...
static void __maybe_unused rtk_sdmmc_wait_stop_cmd_irq_done(void)
{
...
static int __maybe_unused rtk_sdmmc_cpu_wait(char* drv_name, struct rtk_sdmmc_host *rtk_host, u8 cmdcode) {

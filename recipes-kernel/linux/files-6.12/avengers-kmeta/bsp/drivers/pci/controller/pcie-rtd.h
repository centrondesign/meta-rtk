...
#define PCIE_LDO_CTRL 0xF40
#define PCIE_LDO_STS 0xF44
#define PCIE_LDO_PARA 0xF48

#define LDO_DEFAULT_VOLT 0x8
#define EN_LW_PWR BIT(4)
#define EN_PC BIT(3)
#define EN_IB BIT(2)
#define EN_BG BIT(1)
#define EN_LDO BIT(0)
#define LDO_POWER_OK BIT(1)
#define BG_IBHN_BIAS_OK BIT(0)
#define LDO_EFUSE_VALID_BIT BIT(4)
...
#define PCIE_ORDER_CTRL_OFF 0x88c

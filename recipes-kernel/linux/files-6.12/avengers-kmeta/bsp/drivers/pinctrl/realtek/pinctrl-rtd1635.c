...
/*
 * Realtek DHC 1635 pin controller driver
 *
...
static const struct rtd_pin_desc rtd1635_iso_muxes[] = {
	...
	[RTD1635_ISO_UART9_LOC] = RTK_PIN_MUX(uart9_loc, 0x128, GENMASK(19, 17),
		RTK_PIN_FUNC(SHIFT_LEFT(0x1, 17), "uart9_loc0"),
		RTK_PIN_FUNC(SHIFT_LEFT(0x2, 17), "uart9_loc1"),
		RTK_PIN_FUNC(SHIFT_LEFT(0x4, 17), "uart9_loc2")
	),
...
static const struct rtd_pin_desc rtd1635_npu_muxes[] = {
	...
	[RTD1635_NPU_GPIO_133] = RTK_PIN_MUX(gpio_133, 0xc, GENMASK(3, 0),
		RTK_PIN_FUNC(SHIFT_LEFT(0x0, 0), "gpio"),
		RTK_PIN_FUNC(SHIFT_LEFT(0x1, 0), "uart9_loc2"),
		RTK_PIN_FUNC(SHIFT_LEFT(0xc, 0), "acpu_tmbist_ejtag"),
		RTK_PIN_FUNC(SHIFT_LEFT(0xf, 0), "dbg_out0")
	),
	[RTD1635_NPU_GPIO_134] = RTK_PIN_MUX(gpio_134, 0xc, GENMASK(7, 4),
		RTK_PIN_FUNC(SHIFT_LEFT(0x0, 4), "gpio"),
...
static const struct rtd_pin_config_desc rtd1635_iso_configs[] = {
	...
	[RTD1635_ISO_USB_CC1] = RTK_PIN_CONFIG_V2(usb_cc1, 0x30, 0, NA, NA, 0, 1, 2, 3, PADDRI_4_8),
	[RTD1635_ISO_USB_CC2] = RTK_PIN_CONFIG_V2(usb_cc2, 0x30, 4, NA, NA, 0, 1, 2, 3, PADDRI_4_8),
};
...
static const struct rtd_pin_config_desc rtd1635_main2_configs[] = {
	[RTD1635_MAIN2_EMMC_CLK] = RTK_PIN_CONFIG(emmc_clk, 0x14, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_CMD] = RTK_PIN_CONFIG(emmc_cmd, 0x14, 13, 0, 1, NA, 2, 13, NA),
	[RTD1635_MAIN2_EMMC_DATA_0] = RTK_PIN_CONFIG(emmc_data_0, 0x18, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DATA_1] = RTK_PIN_CONFIG(emmc_data_1, 0x18, 13, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DATA_2] = RTK_PIN_CONFIG(emmc_data_2, 0x1c, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DATA_3] = RTK_PIN_CONFIG(emmc_data_3, 0x1c, 13, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DATA_4] = RTK_PIN_CONFIG(emmc_data_4, 0x20, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DATA_5] = RTK_PIN_CONFIG(emmc_data_5, 0x20, 13, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DATA_6] = RTK_PIN_CONFIG(emmc_data_6, 0x24, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DATA_7] = RTK_PIN_CONFIG(emmc_data_7, 0x24, 13, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_DD_SB] = RTK_PIN_CONFIG(emmc_dd_sb, 0x28, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_EMMC_RST_N] = RTK_PIN_CONFIG(emmc_rst_n, 0x28, 13, 0, 1, NA, 2, 12, NA),
	...
	[RTD1635_MAIN2_GPIO_44] = RTK_PIN_CONFIG(gpio_44, 0x34, 12, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_GPIO_45] = RTK_PIN_CONFIG(gpio_45, 0x38, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_GPIO_64] = RTK_PIN_CONFIG(gpio_64, 0x38, 13, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_GPIO_65] = RTK_PIN_CONFIG(gpio_65, 0x3c, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_GPIO_66] = RTK_PIN_CONFIG(gpio_66, 0x3c, 13, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_GPIO_67] = RTK_PIN_CONFIG(gpio_67, 0x40, 0, 0, 1, NA, 2, 12, NA),
	...
	[RTD1635_MAIN2_HIF_CLK] = RTK_PIN_CONFIG(hif_clk, 0x44, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_HIF_DATA] = RTK_PIN_CONFIG(hif_data, 0x44, 13, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_HIF_EN] = RTK_PIN_CONFIG(hif_en, 0x48, 0, 0, 1, NA, 2, 12, NA),
	[RTD1635_MAIN2_HIF_RDY] = RTK_PIN_CONFIG(hif_rdy, 0x48, 13, 0, 1, NA, 2, 12, NA),
};
...
static int rtd1635_pinctrl_probe(struct platform_device *pdev)
{
...
static const struct of_device_id rtd1635_pinctrl_of_match[] = {
	{ .compatible = "realtek,rtd1635-iso-pinctrl", .data = &rtd1635_iso_pinctrl_desc },
	{ .compatible = "realtek,rtd1635-isom-pinctrl", .data = &rtd1635_isom_pinctrl_desc },
	{ .compatible = "realtek,rtd1635-npu-pinctrl", .data = &rtd1635_npu_pinctrl_desc },
	{ .compatible = "realtek,rtd1635-main2-pinctrl", .data = &rtd1635_main2_pinctrl_desc },
	{ .compatible = "realtek,rtd1635-ve2-pinctrl", .data = &rtd1635_ve2_pinctrl_desc },
	{ .compatible = "realtek,rtd1635-ve3-pinctrl", .data = &rtd1635_ve3_pinctrl_desc },
	{},
};
MODULE_DEVICE_TABLE(of, rtd1635_pinctrl_of_match);

static struct platform_driver rtd1635_pinctrl_driver = {
	.driver = {
		.name = "rtd1635-pinctrl",
		.of_match_table = rtd1635_pinctrl_of_match,
		.pm = &realtek_pinctrl_pm_ops,
	},
	.probe = rtd1635_pinctrl_probe,
};

static int __init rtd1635_pinctrl_init(void)
{
	return platform_driver_register(&rtd1635_pinctrl_driver);
}
arch_initcall(rtd1635_pinctrl_init);

static void __exit rtd1635_pinctrl_exit(void)
{
	platform_driver_unregister(&rtd1635_pinctrl_driver);
}
module_exit(rtd1635_pinctrl_exit);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("Realtek Semiconductor Corporation");
MODULE_DESCRIPTION("Realtek DHC SoC RTD1635 pinctrl driver");

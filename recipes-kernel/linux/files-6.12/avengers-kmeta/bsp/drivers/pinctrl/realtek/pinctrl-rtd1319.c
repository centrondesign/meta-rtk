...
/*
 * Realtek DHC 1319 pin controller driver
 *
...
static const struct rtd_pin_config_desc rtd1319_iso_configs[] = {
	[RTD1319_ISO_EMMC_RST_N] = RTK_PIN_CONFIG(emmc_rst_n, 0x1c, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DD_SB] = RTK_PIN_CONFIG(emmc_dd_sb, 0x1c, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_CLK] = RTK_PIN_CONFIG(emmc_clk, 0x20, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_CMD] = RTK_PIN_CONFIG(emmc_cmd, 0x20, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_0] = RTK_PIN_CONFIG(emmc_data_0, 0x24, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_1] = RTK_PIN_CONFIG(emmc_data_1, 0x24, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_2] = RTK_PIN_CONFIG(emmc_data_2, 0x28, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_3] = RTK_PIN_CONFIG(emmc_data_3, 0x28, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_4] = RTK_PIN_CONFIG(emmc_data_4, 0x2c, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_5] = RTK_PIN_CONFIG(emmc_data_5, 0x2c, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_6] = RTK_PIN_CONFIG(emmc_data_6, 0x30, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_EMMC_DATA_7] = RTK_PIN_CONFIG(emmc_data_7, 0x30, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_SPI_CE_N] = RTK_PIN_CONFIG(spi_ce_n, 0x34, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_SPI_SCK] = RTK_PIN_CONFIG(spi_sck, 0x34, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_SPI_SO] = RTK_PIN_CONFIG(spi_so, 0x38, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_SPI_SI] = RTK_PIN_CONFIG(spi_si, 0x38, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_0] = RTK_PIN_CONFIG(gpio_0, 0x38, 24, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_1] = RTK_PIN_CONFIG(gpio_1, 0x38, 28, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_2] = RTK_PIN_CONFIG(gpio_2, 0x3c, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_3] = RTK_PIN_CONFIG(gpio_3, 0x3c, 4, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_4] = RTK_PIN_CONFIG(gpio_4, 0x3c, 8, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_5] = RTK_PIN_CONFIG(gpio_5, 0x3c, 12, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_6] = RTK_PIN_CONFIG(gpio_6, 0x3c, 16, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_7] = RTK_PIN_CONFIG(gpio_7, 0x3c, 20, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_8] = RTK_PIN_CONFIG(gpio_8, 0x3c, 24, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_9] = RTK_PIN_CONFIG(gpio_9, 0x3c, 28, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_10] = RTK_PIN_CONFIG(gpio_10, 0x40, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_11] = RTK_PIN_CONFIG(gpio_11, 0x40, 4, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_12] = RTK_PIN_CONFIG(gpio_12, 0x40, 8, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_13] = RTK_PIN_CONFIG(gpio_13, 0x40, 12, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_14] = RTK_PIN_CONFIG(gpio_14, 0x40, 16, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_15] = RTK_PIN_CONFIG(gpio_15, 0x40, 20, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_16] = RTK_PIN_CONFIG(gpio_16, 0x40, 24, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_17] = RTK_PIN_CONFIG(gpio_17, 0x40, 28, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_18] = RTK_PIN_CONFIG(gpio_18, 0x44, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_19] = RTK_PIN_CONFIG(gpio_19, 0x44, 4, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_20] = RTK_PIN_CONFIG(gpio_20, 0x44, 8, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_21] = RTK_PIN_CONFIG(gpio_21, 0x44, 12, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_22] = RTK_PIN_CONFIG(gpio_22, 0x44, 16, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_23] = RTK_PIN_CONFIG(gpio_23, 0x44, 20, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_USB_CC2] = RTK_PIN_CONFIG(usb_cc2, 0x44, 24, NA, NA, 0, 1, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_25] = RTK_PIN_CONFIG(gpio_25, 0x44, 26, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_26] = RTK_PIN_CONFIG(gpio_26, 0x48, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_27] = RTK_PIN_CONFIG(gpio_27, 0x48, 4, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_28] = RTK_PIN_CONFIG(gpio_28, 0x48, 8, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_29] = RTK_PIN_CONFIG(gpio_29, 0x48, 12, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_30] = RTK_PIN_CONFIG(gpio_30, 0x48, 16, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_31] = RTK_PIN_CONFIG(gpio_31, 0x48, 20, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_32] = RTK_PIN_CONFIG(gpio_32, 0x4c, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_33] = RTK_PIN_CONFIG(gpio_33, 0x4c, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_34] = RTK_PIN_CONFIG(gpio_34, 0x4c, 24, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_35] = RTK_PIN_CONFIG(gpio_35, 0x50, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_HIF_DATA] = RTK_PIN_CONFIG(hif_data, 0x50, 4, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_HIF_EN] = RTK_PIN_CONFIG(hif_en, 0x50, 16, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_HIF_RDY] = RTK_PIN_CONFIG(hif_rdy, 0x54, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_HIF_CLK] = RTK_PIN_CONFIG(hif_clk, 0x54, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_40] = RTK_PIN_CONFIG(gpio_40, 0x58, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_41] = RTK_PIN_CONFIG(gpio_41, 0x58, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_42] = RTK_PIN_CONFIG(gpio_42, 0x5c, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_43] = RTK_PIN_CONFIG(gpio_43, 0x5c, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_44] = RTK_PIN_CONFIG(gpio_44, 0x60, 0, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_45] = RTK_PIN_CONFIG(gpio_45, 0x60, 12, 0, 1, 3, 2, NA, NA),
	[RTD1319_ISO_GPIO_46] = RTK_PIN_CONFIG(gpio_46, 0x60, 24, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_47] = RTK_PIN_CONFIG(gpio_47, 0x60, 28, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_48] = RTK_PIN_CONFIG(gpio_48, 0x64, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_49] = RTK_PIN_CONFIG(gpio_49, 0x64, 4, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_50] = RTK_PIN_CONFIG(gpio_50, 0x64, 8, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_USB_CC1] = RTK_PIN_CONFIG(usb_cc1, 0x64, 12, NA, NA, 0, 1, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_52] = RTK_PIN_CONFIG(gpio_52, 0x64, 14, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_53] = RTK_PIN_CONFIG(gpio_53, 0x64, 18, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_IR_RX] = RTK_PIN_CONFIG(ir_rx, 0x64, 22, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_UR0_RX] = RTK_PIN_CONFIG(ur0_rx, 0x64, 26, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_UR0_TX] = RTK_PIN_CONFIG(ur0_tx, 0x68, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_57] = RTK_PIN_CONFIG(gpio_57, 0x68, 4, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_58] = RTK_PIN_CONFIG(gpio_58, 0x68, 8, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_59] = RTK_PIN_CONFIG(gpio_59, 0x68, 12, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_60] = RTK_PIN_CONFIG(gpio_60, 0x68, 16, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_61] = RTK_PIN_CONFIG(gpio_61, 0x68, 20, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_62] = RTK_PIN_CONFIG(gpio_62, 0x68, 24, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_63] = RTK_PIN_CONFIG(gpio_63, 0x68, 28, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_64] = RTK_PIN_CONFIG(gpio_64, 0x6c, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_65] = RTK_PIN_CONFIG(gpio_65, 0x6c, 4, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_66] = RTK_PIN_CONFIG(gpio_66, 0x6c, 8, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_67] = RTK_PIN_CONFIG(gpio_67, 0x6c, 12, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_68] = RTK_PIN_CONFIG(gpio_68, 0x6c, 16, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_69] = RTK_PIN_CONFIG(gpio_69, 0x6c, 20, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_70] = RTK_PIN_CONFIG(gpio_70, 0x6c, 24, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_71] = RTK_PIN_CONFIG(gpio_71, 0x70, 0, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_72] = RTK_PIN_CONFIG(gpio_72, 0x70, 5, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_73] = RTK_PIN_CONFIG(gpio_73, 0x70, 10, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_74] = RTK_PIN_CONFIG(gpio_74, 0x70, 15, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_75] = RTK_PIN_CONFIG(gpio_75, 0x70, 20, 1, 2, 0, 3, NA, PADDRI_4_8),
	[RTD1319_ISO_GPIO_76] = RTK_PIN_CONFIG(gpio_76, 0x70, 25, 1, 2, 0, 3, NA, PADDRI_4_8),
};
...
static int rtd1319_pinctrl_probe(struct platform_device *pdev)
{
	return rtd_pinctrl_probe(pdev, &rtd1319_iso_pinctrl_desc);
}

static const struct of_device_id rtd1319_pinctrl_of_match[] = {
	{ .compatible = "realtek,rtd1319-pinctrl", },
	{},
};
MODULE_DEVICE_TABLE(of, rtd1319_pinctrl_of_match);

static struct platform_driver rtd1319_pinctrl_driver = {
	.driver = {
		.name = "rtd1319-pinctrl",
		.of_match_table = rtd1319_pinctrl_of_match,
	},
	.probe = rtd1319_pinctrl_probe,
};

static int __init rtd1319_pinctrl_init(void)
{
	return platform_driver_register(&rtd1319_pinctrl_driver);
}
arch_initcall(rtd1319_pinctrl_init);

static void __exit rtd1319_pinctrl_exit(void)
{
	platform_driver_unregister(&rtd1319_pinctrl_driver);
}
module_exit(rtd1319_pinctrl_exit);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("Realtek Semiconductor Corporation");
MODULE_DESCRIPTION("Realtek DHC SoC RTD1319 pinctrl driver");

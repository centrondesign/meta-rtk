...
static const struct rtd1625_gpio_info rtd1635_iso_gpio_info = {
...
static const struct rtd1625_gpio_info rtd1635_isom_gpio_info = {
	.name			= "rtd1635_isom_gpio",
	.gpio_base		= 135,
	.num_gpios		= 4,
	.irq_type_support	= IRQ_TYPE_EDGE_BOTH | IRQ_TYPE_LEVEL_LOW | IRQ_TYPE_LEVEL_HIGH,
	.gpa_offset		= 0x0,
...
static const struct of_device_id rtd1625_gpio_of_matches[] = {
	...
	{ .compatible = "realtek,rtd1635-iso-gpio", .data = &rtd1635_iso_gpio_info },
	{ .compatible = "realtek,rtd1635-isom-gpio", .data = &rtd1635_isom_gpio_info },
	{ }
};

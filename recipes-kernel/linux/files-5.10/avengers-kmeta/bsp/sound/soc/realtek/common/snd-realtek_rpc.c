...
int RPC_TOAGENT_SEND_AUDIO_VERSION(phys_addr_t paddr, void *vaddr,
				 enum OMX_AUDIO_VERSION version)
{
...
int RPC_TOAGENT_CREATE_PP_AGENT(phys_addr_t paddr, void *vaddr, int *ppId,
				 int *pinId)
{

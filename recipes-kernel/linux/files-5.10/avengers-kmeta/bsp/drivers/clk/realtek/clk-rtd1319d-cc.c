...
static struct clk_fixed_factor pll_sd_ref = {
	.div = 6,
	.mult = 1,
	.hw.init = CLK_HW_INIT("pll_sd_ref", "osc27m", &clk_fixed_factor_ops, 0),
};

static struct clk_pll_mmc pll_sd = {
	.pll_ofs = 0x1e0,
	.clkr.hw.init = CLK_HW_INIT("pll_sd", "pll_sd_ref", &clk_pll_sd_ops, 0),
	.phase0_hw.init = CLK_HW_INIT("pll_sd_vp0", "pll_sd", &clk_pll_sd_phase_ops, 0),
	.phase1_hw.init = CLK_HW_INIT("pll_sd_vp1", "pll_sd", &clk_pll_sd_phase_ops, 0),
};
...
static struct clk_fixed_factor rtd1315e_pll_sd_ref = {
	.div = 6,
	.mult = 1,
	.hw.init = CLK_HW_INIT("pll_sd_ref", "osc27m", &clk_fixed_factor_ops, 0),
};

static struct clk_pll_mmc rtd1315e_pll_sd = {
	.pll_ofs = 0x1e0,
	.clkr.hw.init = CLK_HW_INIT("pll_sd", "pll_sd_ref", &clk_pll_sd_v2_ops, 0),
	.phase0_hw.init = CLK_HW_INIT("pll_sd_vp0", "pll_sd", &clk_pll_sd_phase_ops, 0),
	.phase1_hw.init = CLK_HW_INIT("pll_sd_vp1", "pll_sd", &clk_pll_sd_phase_ops, 0),
};
...
static struct clk_hw_onecell_data rtd1319d_cc_hw_data = {
	...
	.hws = {
		...
		[RTD1319D_CRT_PLL_SD_REF] = &pll_sd_ref.hw,
		[RTD1319D_CRT_PLL_SD] = &__clk_pll_mmc_hw(&pll_sd),
		[RTD1319D_CRT_PLL_SD_VP0] = &pll_sd.phase0_hw,
		[RTD1319D_CRT_PLL_SD_VP1] = &pll_sd.phase1_hw,
...
static struct clk_hw_onecell_data rtd1315e_cc_hw_data = {
	...
	.hws = {
		...
		[RTD1319D_CRT_PLL_SD_REF] = &rtd1315e_pll_sd_ref.hw,
		[RTD1319D_CRT_PLL_SD] = &__clk_pll_mmc_hw(&rtd1315e_pll_sd),
		[RTD1319D_CRT_PLL_SD_VP0] = &rtd1315e_pll_sd.phase0_hw,
		[RTD1319D_CRT_PLL_SD_VP1] = &rtd1315e_pll_sd.phase1_hw,
		[RTD1319D_CRT_CLK_SC0] = &__clk_regmap_mux_hw(&clk_sc0),
		[RTD1319D_CRT_CLK_SC1] = &__clk_regmap_mux_hw(&clk_sc1),
		[RTD1319D_CRT_CLK_DET_PLL_BUS] = &__clk_regmap_clkdet_hw(&clk_det_pll_bus),
		[RTD1319D_CRT_CLK_DET_PLL_DCSB] = &__clk_regmap_clkdet_hw(&clk_det_pll_dcsb),

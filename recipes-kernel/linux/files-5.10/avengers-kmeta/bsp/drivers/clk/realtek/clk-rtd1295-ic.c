...
static struct clk_regmap_gate clk_en_ur0 = {
	.clkr.hw.init = CLK_HW_INIT("clk_en_ur0", "osc27m", &clk_regmap_gate_ops, 0),
	.gate_ofs = 0x8c,
	.bit_idx = 8,
};

static struct clk_regmap_gate clk_en_i2c0 = {
	.clkr.hw.init = CLK_HW_INIT("clk_en_i2c0", "osc27m", &clk_regmap_gate_ops, 0),
	.gate_ofs = 0x8c,
	.bit_idx = 9,
};

static struct clk_regmap_gate clk_en_i2c1 = {
	.clkr.hw.init = CLK_HW_INIT("clk_en_i2c1", "osc27m", &clk_regmap_gate_ops, 0),
	.gate_ofs = 0x8c,
	.bit_idx = 10,
};
...
static struct clk_regmap *rtd1295_ic_regmap_clks[] = {
	&clk_en_cec0.clkr,
...
static struct clk_hw_onecell_data rtd1295_ic_hw_data = {
	.num = RTD1295_ISO_CLK_MAX,
	.hws = {
		[RTD1295_ISO_CLK_EN_CEC0] = &__clk_regmap_gate_hw(&clk_en_cec0),
		[RTD1295_ISO_CLK_EN_CBUSRX_SYS] = &__clk_regmap_gate_hw(&clk_en_cbusrx_sys),
		[RTD1295_ISO_CLK_EN_CBUSTX_SYS] = &__clk_regmap_gate_hw(&clk_en_cbustx_sys),
		[RTD1295_ISO_CLK_EN_CBUS_SYS] = &__clk_regmap_gate_hw(&clk_en_cbus_sys),
		[RTD1295_ISO_CLK_EN_CBUS_OSC] = &__clk_regmap_gate_hw(&clk_en_cbus_osc),
		[RTD1295_ISO_CLK_EN_IR] = &__clk_regmap_gate_hw(&clk_en_ir),
		[RTD1295_ISO_CLK_EN_UR0] = &__clk_regmap_gate_hw(&clk_en_ur0),
		[RTD1295_ISO_CLK_EN_I2C0] = &__clk_regmap_gate_hw(&clk_en_i2c0),
		[RTD1295_ISO_CLK_EN_I2C1] = &__clk_regmap_gate_hw(&clk_en_i2c1),
		[RTD1295_ISO_CLK_EN_ETN_250M] = &__clk_regmap_gate_hw(&clk_en_etn_250m),
		[RTD1295_ISO_CLK_EN_ETN_SYS] = &__clk_regmap_gate_hw(&clk_en_etn_sys),
		[RTD1295_ISO_CLK_MAX] = NULL,
	},
};

static struct rtk_reset_bank rtd1295_ic_reset_banks[] = {
	{ .ofs = 0x88, },
};

static const struct rtk_clk_desc rtd1295_ic_desc = {
	.clk_data = &rtd1295_ic_hw_data,
	.clks = rtd1295_ic_regmap_clks,
	.num_clks = ARRAY_SIZE(rtd1295_ic_regmap_clks),
	.reset_banks = rtd1295_ic_reset_banks,
	.num_reset_banks = ARRAY_SIZE(rtd1295_ic_reset_banks),
};

static int rtd1295_ic_probe(struct platform_device *pdev)
{
	return rtk_clk_probe(pdev, &rtd1295_ic_desc);
}

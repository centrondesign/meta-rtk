...
{
	thermal_sensor_device_reg_write(tdev, TM_SENSOR_CTRL0, 0x07f80000);
	thermal_sensor_device_reg_write(tdev, TM_SENSOR_CTRL1, 0x00374000);
	thermal_sensor_device_reg_write(tdev, TM_SENSOR_CTRL2, 0x00011194);
	thermal_sensor_device_reg_write(tdev, TM_SENSOR_CTRL2, 0x00031194);
	regmap_write(tdev->regmap, TM2_SENSOR_CTRL3, 0);
}
...
{
	thermal_sensor_device_reg_write(tdev, SYS_TM_SENSOR_CTRL0, 0x07f80000);
	thermal_sensor_device_reg_write(tdev, SYS_TM_SENSOR_CTRL1, 0x00374000);

...
enum afrc_coding_unit {
	CODING_UNIT_BYTES_16 = 0ULL,
	CODING_UNIT_BYTES_24 = 1ULL,
	CODING_UNIT_BYTES_32 = 2ULL,
};
...
#define RPC_AUDIO_SET_NOTIFY ((1U << 8)) /* SCPU write */
#define RPC_AUDIO_FEEDBACK_NOTIFY ((1U << 9))

#define VO_DC_SET_NOTIFY ((1U << 16)) /* ACPU write */
#define VO_DC_FEEDBACK_NOTIFY ((1U << 17))
#define AUDIO_RPC_SET_NOTIFY ((1U << 24)) /* ACPU write */
#define AUDIO_RPC_FEEDBACK_NOTIFY ((1U << 25))
#else

...
__attribute__((unused)) static void rtk_spi_nor_enable_auto_write(struct rtksfc_host *host)
{
...
__attribute__((unused)) static void rtk_spi_nor_disable_auto_write(struct rtksfc_host *host)
{

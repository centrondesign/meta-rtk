...
static void rtk_type_c_usb_setting(struct type_c_data *type_c, int cc)
{
	...
	type_c->pre_lane = 0;
		...
		/* pwr cut */
		power_cut_0 = DP_AVDD09_TRX_CK_L1 | DP_AVDD09_TRX_CK_L2 |
			DP_AVDD09_RX_OOBS_IN_L2 | DP_AVDD09_DPCMU_CK_CUT;
		writel(power_cut_0 | pc0_default, (base + POWER_CUT_EN0));

		power_cut_1 = DP_AVDD09_TRX_L2 | DP_AVDD09_TRX_RX_L2 | DP_AVDD09_TX_CK_L3 |
				DP_AVDD18_TRX_L2 | DP_AVDD09_TX_CK_L3;
		writel(power_cut_1, (base + POWER_CUT_EN1));
		...
		power_cut_3 = POWERCUT_EN_USB_L2 | DP_AVDD18_TX_L3;
		...
		/* pwr cut */
		power_cut_0 = DP_AVDD09_TRX_CK_L1 | DP_AVDD09_RX_OOBS_IN_L1 |
				DP_AVDD09_TRX_CK_L2 | DP_AVDD09_DPCMU_CK_CUT;
		writel(power_cut_0 | pc0_default, (base + POWER_CUT_EN0));

		power_cut_1 = DP_AVDD09_TX_CK_L0 | DP_AVDD09_TRX_L1 | DP_AVDD09_TRX_RX_L1;
		writel(power_cut_1, (base + POWER_CUT_EN1));

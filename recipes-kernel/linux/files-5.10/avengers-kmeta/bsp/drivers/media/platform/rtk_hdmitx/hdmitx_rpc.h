...
struct VIDEO_RPC_VOUT_CONFIG_HDMI_INFO_FRAME {
	...
	enum rtk_hdr_ctrl_mode hdr_ctrl_mode;
	u_int reserved4;
};
...
struct VIDEO_RPC_VOUT_DISPLAY_OUTPUT_FORMAT {
	...
	enum rtk_hdr_ctrl_mode hdr_mode;
	struct hdmi_infoframe_packet avi_infoframe;
	enum rtk_3d_mode src_3d_fmt;
	enum rtk_3d_mode dst_3d_fmt;
	unsigned int en_dithering;
...
/**
 * struct VIDEO_RPC_VOUT_HDMI_EDID_RAW_DATA -

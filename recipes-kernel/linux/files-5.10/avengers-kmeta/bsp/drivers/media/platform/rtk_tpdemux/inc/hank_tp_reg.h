...
/* TF_CTRL_SWC */ /* invalid(false defs) */
#define TP_TF0_CTRL_SWC   0x000
#define TP_TF1_CTRL_SWC   0x000

#define TPB_TF0_CTRL_SWC  0x000
#define TPB_TF1_CTRL_SWC  0x000

#define TPC_TF0_CTRL_SWC  0x000
...
/* invalid(false defs) */
#define TP_KEY_INFO_SWC_0   0x000
#define TP_KEY_INFO_SWC_1   0x000
#define TP_KEY_INFO_SWC_2   0x000
#define TP_KEY_INFO_SWC_3   0x000
#define TP_KEY_INFO_SWC_4   0x000
#define TP_KEY_INFO_SWC_5   0x000
#define TP_KEY_INFO_SWC_6   0x000
#define TP_KEY_INFO_SWC_7   0x000
#define TP_KEY_INFO_SWC_8   0x000
#define TP_KEY_INFO_SWC_9   0x000
#define TP_KEY_INFO_SWC_A   0x000
#define TP_KEY_INFO_SWC_B   0x000

#define TP_KEY_HEADER_SWC   0x000
#define TP_KEY_MASK_SWC     0x000
#define TP_KEY_CTRL_SWC     0x000

/* define register but these registers are invalid */
#define TPB_KEY_INFO_SWC_0  0x000
#define TPB_KEY_INFO_SWC_1  0x000
#define TPB_KEY_INFO_SWC_2  0x000
#define TPB_KEY_INFO_SWC_3  0x000
#define TPB_KEY_INFO_SWC_4  0x000
#define TPB_KEY_INFO_SWC_5  0x000
#define TPB_KEY_INFO_SWC_6  0x000
#define TPB_KEY_INFO_SWC_7  0x000
#define TPB_KEY_INFO_SWC_8  0x000
#define TPB_KEY_INFO_SWC_9  0x000
#define TPB_KEY_INFO_SWC_A  0x000
#define TPB_KEY_INFO_SWC_B  0x000

#define TPB_KEY_HEADER_SWC  0x000
#define TPB_KEY_MASK_SWC    0x000
#define TPB_KEY_CTRL_SWC    0x000
...
/* Dummy */ /* fasle defs for SWC*/
#define TP_DMY_A     0x65C
#define TP_DMY_B     0x660
#define TP_SWC_DMY_A 0x0000
#define TP_SWC_DMY_B 0x0000
...
#define TPC_SWC_DMY_A 0x0000
#define TPC_SWC_DMY_B 0x0000
...
#define TPB0_NX_NAG_CNTL_1 0x580
...
/* TF_CTRL_SWC */ /* invalid(false defs) */
#define TF_CTRL_SWC_SOLITARY_KEEP_CLEAR(x) ((x & 0x01) << 0)
#define TF_CTRL_SWC_PACKET_SIZE(x)         (x & 0x00)

/* PID_PART */
#define PID_PART_CRC_ADDR_SEL(x)  ((x & 0x01) << 16)
#define PID_PART_CRC_ADDR_SEL_BIT (0x01 << 16)

/* nx is invalid(false def) */
#define TP_PID_DATA2_NX_DIS_DESCRAMBLE(x) ((x & 0x1) << 0)
...
/* TP Scramble */ /* invalid(false defs) */
#define TP_SWC_DMY_A_SCRAMBLE(x) (x & 0x00)

/* NX Mask enc*/
#define ENABLE_TP_NX_MASK_ENC(x) (1 << x)
#define TP_DMY_A_SCRAMBLE_INT_BIT(x) (0x01 << x)

/* from NeptuneTPPID.h */
#define NULL_PID                (0x1FFF)
#define SECTION_BUFFER_SIZE     4096
#define MAX_TSP_SEC_INFO        32
#define MAX_SEC_PER_PID         16

/* from ThorTPPID.h */
#define TP_PID_DATA2_KEY_INDEX(x)           ((x & 0x3F)<<16)
#define TP_PID_DATA2_DIS_DESCRAMBLE         (1<<22)
#define TP_PID_DATA2_TDES_MODE(x)           ((x & 0x1)<<23)
#define TP_PID_DATA2_TDES_MODE_ECB          TP_PID_DATA2_TDES_MODE(0)
#define TP_PID_DATA2_TDES_MODE_CBC          TP_PID_DATA2_TDES_MODE(1)
#define TP_PID_DATA2_AES_MODE(x)            ((x & 0x3)<<24)
#define TP_PID_DATA2_AES_MODE_ECB           TP_PID_DATA2_AES_MODE(0)
#define TP_PID_DATA2_AES_MODE_CBC           TP_PID_DATA2_AES_MODE(1)
#define TP_PID_DATA2_AES_MODE_CTR           TP_PID_DATA2_AES_MODE(2)
#define TP_PID_DATA2_AES_MODE_ATIS          TP_PID_DATA2_AES_MODE(3)
#define TP_PID_DATA2_DES_SEL(x)    		    ((x & 0xF)<<26)
#define TP_PID_DATA2_DES_SEL_AES            TP_PID_DATA2_DES_SEL(0)
#define TP_PID_DATA2_DES_SEL_TDES           TP_PID_DATA2_DES_SEL(1)
#define TP_PID_DATA2_DES_SEL_ASA_LIGHT      TP_PID_DATA2_DES_SEL(7)
#define TP_PID_DATA2_DES_SEL_ASA            TP_PID_DATA2_DES_SEL(8)
#define TP_PID_DATA2_DES_SEL_DVB_CSA3       TP_PID_DATA2_DES_SEL(9)
#define TP_PID_DATA2_DES_SEL_DVB_CSA2       TP_PID_DATA2_DES_SEL(0xA)

...
TRACE_EVENT(hdmitx_hotplug_state,
	...
	TP_PROTO(int state, int old_state, int rx_sense),

	TP_ARGS(state, old_state, rx_sense),
	...
	TP_printk("state:%d, RxSense:%d, orig:%d%s",
		__entry->state,	__entry->rx_sense, __entry->old_state,

...
#if 0
	void __iomem *reg_TP_TF_SYNA_CTRL;
	void __iomem *reg_TP_TF_SYNA_INT;
#endif
...
#if 1
	void __iomem *reg_TP_KEY_INFO_REE_0;
	void __iomem *reg_TP_KEY_INFO_REE_1;
	void __iomem *reg_TP_KEY_INFO_REE_2;
	void __iomem *reg_TP_KEY_INFO_REE_3;
	void __iomem *reg_TP_KEY_INFO_REE_4;
	void __iomem *reg_TP_KEY_INFO_REE_5;
	void __iomem *reg_TP_KEY_INFO_REE_6;
	void __iomem *reg_TP_KEY_INFO_REE_7;

	void __iomem *reg_TP_KEY_CTRL_NWC;
	void __iomem *reg_TP_KEY_HEADER_REE;
	void __iomem *reg_TP_KEY_MASK_REE;
#endif
...
#if 1
	void __iomem *reg_TP_PID_DATA4;
	void __iomem *reg_TP_PID_DATA5;
	void __iomem *reg_TP_PID_DATA6;
#endif

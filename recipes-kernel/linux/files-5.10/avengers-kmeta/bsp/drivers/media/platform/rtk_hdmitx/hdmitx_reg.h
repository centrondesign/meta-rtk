...
#if IS_ENABLED(CONFIG_RTK_HDMI_RTD1325)
#define VER_CTRL                                                                     0x50
#define VER_CTRL_reg_addr                                                            "0x9804d850"
#define VER_CTRL_reg                                                                 0x9804d850
#define VER_CTRL_clk_pixel_occ_src_sel_shift                                         (8)
#define VER_CTRL_clk_pixel_occ_src_sel_mask                                          (0x100)
#define VER_CTRL_clk_pixel_occ_src_sel(data)                                         (0x100&((data)<<8))
#define VER_CTRL_clk_pixel_occ_src_sel_src(data)                                     ((0x100&(data))>>8)
#define VER_CTRL_get_clk_pixel_occ_src_sel(data)                                     ((0x100&(data))>>8)
#define VER_CTRL_hdmi_new_clk_sel_shift                                              (4)
#define VER_CTRL_hdmi_new_clk_sel_mask                                               (0x10)
#define VER_CTRL_hdmi_new_clk_sel(data)                                              (0x10&((data)<<4))
#define VER_CTRL_hdmi_new_clk_sel_src(data)                                          ((0x10&(data))>>4)
#define VER_CTRL_get_hdmi_new_clk_sel(data)                                          ((0x10&(data))>>4)
#define VER_CTRL_all_block_cgen_shift                                                (1)
#define VER_CTRL_all_block_cgen_mask                                                 (0x2)
#define VER_CTRL_all_block_cgen(data)                                                (0x2&((data)<<1))
#define VER_CTRL_all_block_cgen_src(data)                                            ((0x2&(data))>>1)
#define VER_CTRL_get_all_block_cgen(data)                                            ((0x2&(data))>>1)
#define VER_CTRL_block_ver_ctl_shift                                                 (0)
#define VER_CTRL_block_ver_ctl_mask                                                  (0x1)
#define VER_CTRL_block_ver_ctl(data)                                                 (0x1&((data)<<0))
#define VER_CTRL_block_ver_ctl_src(data)                                             ((0x1&(data))>>0)
#define VER_CTRL_get_block_ver_ctl(data)                                             ((0x1&(data))>>0)
#endif /* end of IS_ENABLED(CONFIG_RTK_HDMI_RTD1325) */

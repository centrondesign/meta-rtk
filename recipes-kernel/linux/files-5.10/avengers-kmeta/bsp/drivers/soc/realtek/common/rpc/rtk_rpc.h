		...
		uint32_t out, char *buf, int datasize)
{
	...
	ringIn = dev->ringIn;
#endif
	size = __get_ring_data_size(ringStart, ringEnd, ringIn, out);
	tail = ringEnd - out;

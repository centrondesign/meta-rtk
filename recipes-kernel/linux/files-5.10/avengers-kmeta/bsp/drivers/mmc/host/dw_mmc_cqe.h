...
#define SDMMC_ADMA_SA_HIGH_R			0x05c

#define SDMMC_MSHC_CTRL_R                     	0x208
#define SDMMC_CTRL_R                          	0x22c
#define SDMMC_MSHC_CTRL_R_KENT			0x108
#define SDMMC_CTRL_R_KENT			0x12c
...
#define SDMMC_HOST_ADDRESSING			BIT(13)

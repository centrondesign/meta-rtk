...
#define RTD1625_REV_OTP 0x98032540
#define RTD1625_REV_OTP_MASK 0xffff
#define RTD1625_REV_OTP_A01 0x1

static bool is_kent_a00(void)
{
	if (RTD1xxx_CHIP_REVISION_A00 == get_rtd1xxx_cpu_revision()) {
		int otp_val = (*(unsigned int *)RTD1625_REV_OTP) & RTD1625_REV_OTP_MASK;

		if (otp_val == RTD1625_REV_OTP_A01)
			return false;
		else
			return true;
	}
...
#define AUTO_INVERT_EN BIT(26)
	...
	if (is_kent_a00()) {
		printf("Kent A00 fix bc mododule\n");

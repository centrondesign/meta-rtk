/*
 * Configuration settings for the Realtek 1635 QA board.
 *
 * Won't include this file.
 * Just type "make <board_name>_config" and will be included in source tree.
 */

#ifndef __CONFIG_RTK_RTD1635_EMMC_H
#define __CONFIG_RTK_RTD1635_EMMC_H

/*
 * Include the common settings of RTD1635 platform.
 */
...
#endif /* __CONFIG_RTK_RTD1635_EMMC_H */
